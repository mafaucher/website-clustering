...
<title>Nous situer - Universit&eacute; Concordia - Montr&eacute;al, Qu&eacute;bec, Canada</title>
...
relative_path = "../../";
data_path = "../../custom/";
pagetitle="Nous situer";
uri = "/fr/concordia-en-bref/nous-situer/";
member = 1;
</script>
...
<body id="body_li_nous-situer_2" class="li_mainmenu_concordia-en-bref_1 li_submenu_nous-situer_2" >
...
<div id="search" class="search">
		...
		<div class="search-panes">
			<form name="conuni_search" id="conuni_search" action="http://www.concordia.ca/fr/concordia-en-bref/nous-situer/#" method="post">
...
<a class="li_mainmenu_concordia-en-bref_1_a" href="../index.html">
...
<li id="li_submenu_nous-situer_2" class="active">
<strong>Nous situer </strong></li>
...
Contactez&ndash;nous </a>
		...
		<div id="lh_menu">
<ul class="level_3">
<li id="li_visite-de-concordia_3"> <a class="li_visite-de-concordia_3_a" href="visite-de-concordia/index.html">
Visite de Concordia </a>
 </li>
<li id="li_carte-des-campus_3"> <a class="li_carte-des-campus_3_a" href="../../../about/contact/campus-map/index.html">
Carte des campus (En anglais)</a>
</li>
<li id="li_nous-trouver_3"> <a class="li_nous-trouver_3_a" href="nous-trouver/index.html">
Nous trouver </a>
</li>
<li id="li_montreal-en-bref_3"> <a class="li_montreal-en-bref_3_a" href="montreal-en-bref/index.html">
Montr&eacute;al<br />en bref </a>
</li>
</ul>
</div>&nbsp;
	</div>
		<div class="insidecontent  twothirds">
			...
			<p class="breadcrumb"><a href="../../index.html">Universit&eacute; Concordia</a> &gt; <a href="../index.php">Concordia en bref</a> &gt; </p>
			<h1>Nous situer</h1>
...
<!-- InstanceBeginEditable name="MainContent" -->
  <p style="margin-top: 0; margin-bottom: 0">Grand p&ocirc;le universitaire situ&eacute; &agrave; Montr&eacute;al (Qu&eacute;bec), Concordia poss&egrave;de deux campus situ&eacute;s &agrave; environ 7 km de distance : Sir-George-Williams, au c&oelig;ur du centre-ville, et Loyola, dans un quartier r&eacute;sidentiel de l&rsquo;ouest de la ville. Un service de <a href="http://www.concordia.ca/fr/navette.php">navette</a> gratuit pour les &eacute;tudiants, professeurs et membres du personnel, les relie. </p>
  <p style="margin-top: 0; margin-bottom: 0;">&nbsp;</p>
  <h2><a href="visite-de-concordia/index.html">Visite de Concordia</a></h2>
    <p>Curieux d&rsquo;en savoir davantage sur Concordia? Faites une visite virtuelle de nos deux campus. Et si vous avez l&rsquo;intention de venir &agrave; Montr&eacute;al, pourquoi ne pas organiser une visite de l&rsquo;Universit&eacute;?</p>
        <h2><a href="../../../about/contact/campus-map/index.html">Cartes des campus (en anglais)</a></h2>
    <p>Pour vous y retrouver &agrave; l&rsquo;Universit&eacute; ou pour vous rendre &agrave; un pavillon en particulier, consultez les cartes des campus.</p>
        <h2><a href="nous-trouver/index.html">Nous trouver</a></h2>
    <p>En route pour &eacute;tudier &agrave; Concordia? Que vous voyagiez en avion, en train, en autocar ou en voiture, suivez ces directions &agrave; destination de Montr&eacute;al. </p>
        <h2><a href="montreal-en-bref/index.html">Montr&eacute;al en bref</a></h2>
    <p>La ville de Montr&eacute;al sert de toile de fond &agrave; l&rsquo;Universit&eacute; Concordia. Quel dynamisme!</p>
...
<!-- InstanceBeginEditable name="Sidebar" -->
  <h2>Notre avenir</h2>
    <h3>Construire Concordia</h3>
  <p>Concordia vise l&rsquo;excellence pour ses installations, notamment ses nouveaux projets de pavillons et de r&eacute;sidences. Depuis plus de cent ans, nous am&eacute;liorons et d&eacute;veloppons constamment notre infrastructure et cr&eacute;ons un environnement id&eacute;al pour l&rsquo;apprentissage, l&rsquo;enseignement et la recherche afin de r&eacute;pondre &agrave; nos besoins et de construire l&rsquo;avenir. </p>
  
  <div class="dropshadow small"><img class="framed" src="http://www.concordia.ca/images/about-concordia/where-we-are/sciencecomplex.jpg" alt="Renaud Science Complex" width="250" height="87" /></div>
<p class="photocaption">Complexe des sciences Richard-J.-Renaud</p>
  <p>Visitez le <a href="../../../../websitebuildings.concordia.ca/">site Web Construire Concordia</a>.</p>
<!-- InstanceEndEditable --><br class="hide" />
			</div>
...
<div id="footer">
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.concordia.ca/fr/concordia-en-bref/nous-situer/#top">Haut de page</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Nous situer - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.concordia.ca/fr/concordia-en-bref/nous-situer/index.php ...</p>
