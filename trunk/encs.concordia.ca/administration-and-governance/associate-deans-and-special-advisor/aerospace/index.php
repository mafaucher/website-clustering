...
<head>
	...
	<title>Aerospace - Engineering &amp; Computer Science - Concordia University - Montreal, Quebec, Canada</title>
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fadministration-and-governance%2Fassociate-deans-and-special-advisor%2Faerospace%2Findex.php','Aerospace', '/');
					});
	}
...
<body id="body_li_aerospace_3" class="li_mainmenu_administration-and-governance_1 li_submenu_associate-deans-and-special-advisor_2 li_aerospace_3" >
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/administration-and-governance/associate-deans-and-special-advisor/aerospace/index.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<a class="li_submenu_associate-deans-and-special-advisor_2_a" href="../">
...
<li id="li_aerospace_3"> <strong>
<span>Aerospace</span> </strong>
 <ul class="level_4">
<li id="li_aerospace-activities_4"> <a class="li_aerospace-activities_4_a" href="aerospace-activities/index.html">
<span>Aerospace Activities</span> </a>
</li>
</ul> </li>
</ul>
</div>
		...
		<div class="insidecontent ">
			...
			<p class="breadcrumb"><a href="../../../index.html">ENCS Home</a> &gt; <a href="../../index.php">Administration &amp; governance</a> &gt; <a href="../index.php">Associate Deans &amp; Special Advisor</a> &gt; </p>
...
<!-- InstanceBeginEditable name="Sidebar" -->
  ...
  <h2>CIADI</h2>
  <p>The Aerospace Special Advisor works closely with the <a href="http://ciadi.concordia.ca/">Concordia Institute for Aerospace Design and Innovation</a>. CIADI's objective is to promote awareness and provide leading edge know-how among engineering students in aerospace design and innovation. CIADI&rsquo;s approach is multi-disciplinary in nature and its efforts are focused on ever-evolving aerospace technologies. CIADI, part of the Faculty of Engineering and Computer Science provides excellent training opportunities for students seeking a career in the aerospace industry.</p>
  </div>
...
<!-- InstanceBeginEditable name="MainContent" -->
  ...
  <h2>Dr. R. Fews, Aerospace Special Advisor</h2>
  <div class="dropshadow imgfloatleft"><img src="http://www.encs.concordia.ca/images/staff-bob.jpg" width="142" height="214" class="framed" alt="Robert Fews"></div>
  <p>In late 2009, Dr. Robert Fews was Aerospace Special Advisor to the Faculty of Engineering and Computer Science. This new position was established in order to facilitate the creation and promotion of apprenticeship opportunities for ENCS students, as well as to help integrate students into the workforce at both the graduate and undergraduate levels. The Aerospace Special Advisor will also play an important role in promoting ENCS&rsquo;s aerospace-related activities and programs internally and externally.</p>
    <p>Originally hailing from England, Dr. Fews completed a five-year apprenticeship with British Aerospace Ltd, where went on to work as a structures engineer on the Concorde SST project before pursuing a PhD in Aircraft Design from the Cranfield Institute of Technology.  Dr. Fews then came to Canada in 1978, when he accepted a position as Senior Staff Specialist at Canadair Ltd in Montreal. In 1984, he joined Bell Helicopter Textron Canada, where he served as Manager of Technology until 2002, when he became Director of Research for the company, a position which he held until 2009.</p>
    <p>Said Dr. Fews of his appointment, &ldquo;I feel honoured to be part of the Faculty of Engineering and Computer Science because it has established itself as a major centre for aerospace research and teaching in Montreal.&rdquo; Indeed, Concordia has been a leader in collaborations with industry, as evidenced by its establishment of the Concordia Institute for Aerospace Design and Innovation, as well as its involvement in the Consortium for Research and Innovation in Aerospace in Quebec. With Dr. Robert Fews as a new member of the ENCS team, the Faculty is sure to remain an important leader in this dynamic field.
    </p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/administration-and-governance/associate-deans-and-special-advisor/aerospace/index.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Aerospace - Concordia University - Montreal, Quebec, Canada</p>
