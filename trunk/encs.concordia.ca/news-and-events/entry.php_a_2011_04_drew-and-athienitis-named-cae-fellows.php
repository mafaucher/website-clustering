...
<head>
	...
	<title>
Drew and Athienitis named CAE Fellows
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F04%2Fdrew-and-athienitis-named-cae-fellows.php','%0ADrew%20and%20Athienitis%20named%20CAE%20Fellows%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/04/drew-and-athienitis-named-cae-fellows.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Drew and Athienitis named CAE Fellows
			...
			<div class="entry-meta" title="2011-04-27T08:55:12-05:00">Wednesday Apr 27, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<a href="../administration-and-governance/about-the-dean/index.html">Dr. Robin A. L. Drew</a>, Dean of the Faculty of Engineering and Computer Science and Professor in the <a href="http://www.me.concordia.ca/">Department of Mechanical and Industrial Engineering</a>; and Dr. Andreas Athienitis, Director of the <a href="http://www.solarbuildings.ca/en/network">NSERC Solar Buildings Research Network</a> and Professor in the <a href="http://www.bcee.concordia.ca/index.php/Main_Page">Department of Building, Civil and Environmental Engineering</a> have both been awarded Fellowships of the Canadian Academy of Engineering (CAE).<br /><br /><img alt="DSCN3364.JPG" src="http://newsfeed.encs.concordia.ca/encs_test/DSCN3364.JPG" class="mt-image-center" style="text-align: center; display: block; margin: 0pt auto 20px;" width="440" height="388" />This recognition represents the highest achievement in engineering in Canada.&nbsp; The Academy comprises of the country's most accomplished engineers, who are dedicated to the application of science and engineering principles in the interests of the country and its enterprises. Members of the Academy are nominated and elected by their peers for their distinguished achievements and career-long service to the engineering profession. Presently, there are only 346 active Fellows. Here at Concordia, only three other faculty members hold Fellowships from the CAE. Provost David Graham called this "wonderful news" and extended his heartfelt congratulations: a sentiment echoed by the members of the Faculty of Engineering and Computer Science.<br /><br />Drew and Athienitis will be officially inducted as Fellows of the Academy during the CAE's 2011 Annual General Meeting and Symposium, which will be held in Vancouver on June 2nd. <br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/04/drew-and-athienitis-named-cae-fellows.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Drew and Athienitis named CAE Fellows
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/04/drew-and-at...llows.php </p>
