...
<head>
	...
	<title>
CIISE students finalists at the OCTAS
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2009%2F04%2Fciise-students-finalists-at-the-octas.php','%0ACIISE%20students%20finalists%20at%20the%20OCTAS%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/04/ciise-students-finalists-at-the-octas.php#maincontent" accesskey="s">Skip to Content</a></li>
...
CIISE students finalists at the OCTAS
			...
			<div class="entry-meta" title="2009-04-10T10:13:00-05:00">Friday Apr 10, 2009</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<p>A group of students from the Computer Security Laboratory at the Concordia Institute for Information Systems Engineering were selected as finalist for the OCTAS'2009 competition during the gala that took place at the Opera Club on April 8th, 2009. The OCTAS competition is organized by the "<a class="zem_slink" href="http://www.fiq.qc.ca/" title="Fédération de l'informatique du Québec" rel="homepage">Fédération de l'Informatique du Québec</a> (FIQ)" and is a unique opportunity to recognize the achievement of excellence in Quebec's Information Technology industry. Each year the FIQ rewards individuals, companies, universities or organizations for their creativity, vitality and exceptional contribution to the growth of the IT. Our students are finalists in the "Releve Etudiante - Universitaire". For more details on the award, please visit the <a href="http://www.production-equinoxe.com/octas2009/">OCTAS website</a>.</p><p><a href="http://newsfeed.encs.concordia.ca/encs_test/OCTAS_web.jpg"><img alt="OCTAS_web.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/assets_c/2010/01/OCTAS_web-thumb-440x293-11.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" width="440" height="293" /></a></p>

<p>The students worked on a project that addressed the "Security Evaluation and Hardening of Free and Open Source Software: A Synergy between Aspect Orientation and Security Hardening Patterns". The objectives of this research are to:</p>

<ul>
<li>Elaborate methodologies for integrating practical and efficient tools for the security evaluation of free and open source software products;</li>
<li>Build and implement a catalogue of validated security hardening patterns that compiles the know-how of security experts;</li>
<li>Devise an aspect-oriented framework for the systematic security hardening of free and open source software products;</li>
<li>Elaborate robust semantic theoretical foundations for security evaluation and hardening of free and open source applications.</li></ul>

<p>The students affiliated with this project published 36 research publications in high quality international journals and conferences (10 journals papers, 2 book chapters, and 24 conference papers). The project is funded by <a class="zem_slink" href="http://www.nserc.ca/" title="Natural Sciences and Engineering Research Council" rel="homepage">NSERC</a>, National Defense, and <a class="zem_slink" href="http://www.bell.ca/" title="Bell Canada" rel="homepage">Bell Canada</a> at a level of $777,000 for three years.</p>

<p>The students are:</p>

<ul>
<li>Marc-André Laverdière (MSc)</li>
<li>Nadia Belblidia (PhD)</li>
<li>Syrine Tlili (PhD)</li>
<li>Dima Alhadidi (PhD)</li>
<li>Aiman Hanna (PhD)</li>
<li>Xiaochun Yang (MSc)</li>
<li>Mourad Azzam (PhD)</li>
<li>Zhenrong Yang (MSc)</li>
<li>Amine Boukhetouta (MSc)
</li><li>Rachid Hadjidj (Post-Doctoral Fellow)</li>
<li>Hakim Idrissi Kaitouni (MSc)</li>
<li>Hai Zhou Ling (MSc)</li></ul>


<div style="margin-top: 10px; height: 15px;" class="zemanta-pixie"><a class="zemanta-pixie-a" href="http://reblog.zemanta.com/zemified/ef5fd460-f198-4b2b-b3fa-f5a8d77dd3f7/" title="Reblog this post [with Zemanta]"><img style="border: medium none ; float: right;" class="zemanta-pixie-img" src="http://img.zemanta.com/reblog_e.png?x-id=ef5fd460-f198-4b2b-b3fa-f5a8d77dd3f7" alt="Reblog this post [with Zemanta]" /></a><span class="zem-script more-related pretty-attribution"><script type="text/javascript" src="http://static.zemanta.com/readside/loader.js" defer="defer"></script></span></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/04/ciise-students-finalists-at-the-octas.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
CIISE students finalists at the OCTAS
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2009/04/ciise-stude...octas.php </p>
