...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F01%2Ffaculty-goes-fair-trade.php','%0AFaculty%20goes%20Fair%20Trade%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/01/faculty-goes-fair-trade.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Faculty goes Fair Trade
			...
			<div class="entry-meta" title="2011-01-24T13:29:09-05:00">Monday Jan 24, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="FT.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/FT.jpg" class="mt-image-left" style="float: left; margin: 0pt 20px 20px 0pt;" height="301" width="220" /><div>The Faculty of Engineering and Computer Science is going Fair Trade! <br /><br />As the result of the push by the Concordia Chapter of Engineers Without Borders, following the very successful Wine and Cheese event in the fall where Fair Trade was the topic, Faculty officials successfully secured a Fair Trade supplier of coffee and tea that is both cost-effective and of good quality.&nbsp; <br /><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/01/faculty-goes-fair-trade.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Faculty goes Fair Trade
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/01/faculty-goe...trade.php </p>
