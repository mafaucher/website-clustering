...
<head>
	...
	<title>
ENCS Alumnus Named New Face of Engineering
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F02%2Fencs-alumnus-named-new-face-of-engineering.php','%0AENCS%20Alumnus%20Named%20New%20Face%20of%20Engineering%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/02/encs-alumnus-named-new-face-of-engineering.php#maincontent" accesskey="s">Skip to Content</a></li>
...
ENCS Alumnus Named New Face of Engineering
			...
			<div class="entry-meta" title="2011-02-18T15:25:11-05:00">Friday Feb 18, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="Javad_Lavaei.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Javad_Lavaei.jpg" class="mt-image-left" style="float: left; margin: 0pt 20px 20px 0pt;" height="203" width="220" />Javad Lavaei is no stranger to accolades. In 2008, the then-MASc Student from the Department of Electrical and Computer Engineering was the recipient of the Governor General's Gold Medal, awarded each year at fall convocation to Concordia's most outstanding graduate student. In 2010, he was awarded the Northeastern Association of Graduate Schools Master's Thesis Award for 2009-2010. <br /><br />Now, he's done it again. This current PhD candidate at the California Institute of Technology has just been named a "New Face of Engineering" by the National Engineers Week Foundation in the United States. Every year, the organization asks its members to nominate colleagues 30 years old and younger who have shown outstanding abilities and leadership. These New Faces represent the best of the best in the field - the next generation of engineers whose innovation, leadership skills and commitment to excellence are helping to better our world and inspire young people to consider careers in engineering. <br /><br />As a senior member of the international IEEE organization and rising star on the academic scene, Lavaei was the perfect candidate. His former Concordia supervisor couldn't agree more. "I'm very lucky to have supervised many brilliant graduate students during my career at Concordia University, and am equally proud of all of them," he says. "Javad's extraordinary intelligence allowed him to obtain exciting research results, from which he published several papers in the most prestigious journals and conferences. I take pride in having mentored this brilliant young gentleman,
whose recognitions have put Concordia University on the spotlight at
the national and international levels, repeatedly."<br /><br />These sentiments are mirrored by Lavaei himself, who warmly stated, "I would like to thank Concordia University and in particular my former advisor, Dr. Amir Aghdam, for shaping my academic career and helping me become a successful engineer."<br /><br />"New Faces" is designed to promote the importance of technical education, celebrate engineering careers and recognize significant contributions to the engineering profession and society. Each year, the EWeek website features the photos and biographies of five notable young engineers. In addition, the top nominees are recognized during EWeek in a full-page ad in USA Today.<br /><br />National Engineers Week takes place February 20-26, 2011. <br /><br /><b>Related links:</b><br />EWeek website - <a href="http://www.eweek.org/">www.eweek.org</a><br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/02/encs-alumnus-named-new-face-of-engineering.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
ENCS Alumnus Named New Face of Engineering
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/02/encs-alumnu...ering.php </p>
