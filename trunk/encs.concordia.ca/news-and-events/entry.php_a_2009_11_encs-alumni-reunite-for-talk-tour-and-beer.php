...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2009%2F11%2Fencs-alumni-reunite-for-talk-tour-and-beer.php','%0AENCS%20alumni%20reunite%20for%20talk%2C%20tour%20and%20beer%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/11/encs-alumni-reunite-for-talk-tour-and-beer.php#maincontent" accesskey="s">Skip to Content</a></li>
...
ENCS alumni reunite for talk, tour and beer
			...
			<div class="entry-meta" title="2009-11-01T17:18:13-05:00">Sunday Nov  1, 2009</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
As part of Concordia's Homecoming 2009 festivities, the Faculty of Engineering and Computer Science played host to nearly 100 alumni from the classes of 1959 and earlier and 1964, 1969, 1974, 1979, 1984 and 1989. Former students and current and former professors gathered for a stimulating discussion, an eye-opening tour and a heart-warming reunion to celebrate their milestone years.<br /><br /><a href="http://newsfeed.encs.concordia.ca/encs_test/homecoming.jpg"><img alt="Homecoming" src="http://newsfeed.encs.concordia.ca/encs_test/assets_c/2010/01/homecoming-thumb-440x292-59.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" width="440" height="292" /></a><b>Back in the classroom</b><br /><br />The day was kicked off by <b>Pragasen Pillay</b>, Concordia professor of Electrical and Computer Engineering and Hydro-Quebec Chair in Energy Efficiency and Renewable Energy, who spoke about the timely topic of "Renewable Energy for the Future." Pillay began the early-afternoon talk by polling audience members on their interests in renewable energy and then provided an overview of the planet's current energy crisis. Pillay said he's optimistic for a future that would be shaped in part by today's engineering students. He explained how modern wind turbines, solar panels and anaerobic composting can have a positive impact on our environment.<br /><br />Pillay pointed to constructive initiatives, such as Sustainable Concordia and the Solar Research Building Network, led by his colleague, <b>Andreas Athienitis</b>, Concordia University Research Chair in Solar Energy and professor of Building, Civil and Environmental Engineering Pillay described a potential renewable energy project, a huge industrial composter on the Hall Building roof. If the project, known as an "urban biomass system," were to receive funding, it would be the first of its kind in Canada, Pillay pointed out.<br /><b><br />Touring the past and present</b><br /><br />Engineering and Computer Science alumni and guests then joined <b>Guy Gosselin</b>, the Faculty's manager of Planning and Operations Facilities, for a behind-the-scenes tour of the Engineering, Computer Science and Visual Arts Integrated Complex (EV Building) and Hall Building.<br /><br />The first stop was the composites lab on the EV Building's14 th floor, where PhD candidates explained and demonstrated in-progress research projects. Then, the visitors headed across the street to the Hall Building to see recent renovations and visit their former classrooms. One alumnus joked, "The escalators still aren't working!"<br /><br /><br /><b>Back at the bar for memories and drinks</b><br /><br />To cap the festivities, about 60 alumni, professors and guests gathered in Reggie's Bar in the Hall Building and mingled, reminisced and happily imbibed Reggie's finest brews. Former Engineering and Computer Science associate dean <b>Terry Fancott </b>hosted the reception. Fancott pointed out<b> Jose Bakker</b>, S BEng 69, as the program's first female graduate. His nostalgic speech induced many laughs and he presented a slideshow featuring old photos of students and professors.<br /><br />The crowd applauded the sight of former faculty members such as <b>Clair Callaghan</b>, <b>Matthew Douglas </b>and<b> Jack Bordan</b>. Bordan, the Faculty's first dean, appeared in a pre-taped video. He warmly thanked the Faculty for establishing the Jack Bordan Undergraduate Entrance Scholarships in Engineering and Computer Science. (For more information or to contribute to the scholarship endowment, contact Sarah Kenny, development officer, Engineering and Computer Science, at sarah@encs.concordia.ca or 514-848-2424, ext. 7026).<br /><br />The group also heard from<b> Robin Drew</b>, the Faculty's current dean, and Roland Fabry, the first person to register for Sir George Williams University's Certificate Program in Engineering in 1958.<br /><br />The evening wrapped up with alumni and professors sharing pints and good cheer and many said they were already looking forward to their next reunion.<br /><br />Check out the <a href="http://alumni.concordia.ca/images/events/homecoming/2009/EC-Reunion/album/">slideshow</a> of photos from the event! <br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/11/encs-alumni-reunite-for-talk-tour-and-beer.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
ENCS alumni reunite for talk, tour and beer
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2009/11/encs-alumni...-beer.php </p>
