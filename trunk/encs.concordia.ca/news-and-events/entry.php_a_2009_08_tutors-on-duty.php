...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2009%2F08%2Ftutors-on-duty.php','%0ATutors%20on%20Duty%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/08/tutors-on-duty.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Tutors on Duty
			...
			<div class="entry-meta" title="2009-08-30T15:57:36-05:00">Sunday Aug 30, 2009</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
In our Faculty, students learn by solving problems. We learn by doing! We practice engineering and computer science through homework assignments, laboratories, and projects.

But sometimes you need a little help to get started with a homework problem. Though many of our first- and second-year courses have tutorial sessions, the tutorial might come a little too late to be of much use in solving homework problems in time for the due date.

<br /><br />That's why we're starting a new tutorial service in ENCS called "Tutors-on-duty" or ToDs: to give you the help you need, when you need it. The ToDs will be available to help you get started with a homework problem, and are there to help explain what the problem is asking and how it relates to the methods that were taught in class. The ToD can help you to get started in solving the problem by suggesting a good approach. Or the ToD can help you with the concepts of a course that is giving you a headache.  The ToDs are there to help you stay ahead of the game by providing you with help well in advance of the due date for a homework assignment.

<br /><br />The ToD program is aimed mainly at first- and second-year courses. ToDs are expected to be able to help you with problems in the Faculty's core courses such as EMAT 213 and 233, and with the more specialized courses offered by their department. Each department has been asked to appoint four ToDs, so there are four time slots in the week when you can get help with, say, the circuits course offered by Electrical and Computer Engineering.  Also, the General Studies Unit will provide two ToDs to help with the technical communication course, as well as with report-writing, citation of references, preparing presentations, and so forth.

<br /><br />Two ToDs will be available, in rooms H-806-01 and H-806-02, according to the the schedule found <a href="https://webdev.encs.concordia.ca/Design/resources/tutors-on-duty/">here</a>.

<br /><br />We can't expect every ToD to be an expert in every course! As you become more familiar with the service, you'll get to know which ToD is best for, say, C++ programming, and which ToD is the best one to ask about thermodynamics.

To provide the Associate Dean of Academic Affairs with confidential feedback so that I can evaluate the usefulness of the ToD program, you will be asked to give the ToD your name and ID number.  <br /><br />If the service is popular with students, then perhaps we can offer more ToD hours in future semesters.

We hope that the ToD service will give you help when you need it and contribute to your success in Engineering and Computer Science. 
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/08/tutors-on-duty.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Tutors on Duty
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2009/08/tutors-on-d...p </p>
