...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F01%2Fengineering-new-uses-for-smartphones.php','%0AEngineering%20new%20uses%20for%20smartphones%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/01/engineering-new-uses-for-smartphones.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Engineering new uses for smartphones
			...
			<div class="entry-meta" title="2011-01-14T16:02:33-05:00">Friday Jan 14, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="Glitho-web.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Glitho-web.jpg" class="mt-image-left" style="float: left; margin: 0pt 20px 20px 0pt;" height="245" width="220" /><i>This article by Russ Cooper originally appeared in the January 12, 2011 edition of the <a href="http://now.concordia.ca/">Concordia NOW</a> web bulletin.</i><br /><br />With the appointment of Roch Glitho as Canada Research Chair in End-User Service Engineering for Communications Networks comes the potential to unlock a world of communications possibilities.<br /><br />As a professor at the Concordia Institute for Information Systems Engineering, Glitho is developing applications to adapt cellphones for a range of new functions. He is exploring how geolocating software can allow cellphone users to better interact with their environments (be reminded of items to purchase when passing a pharmacy or grocery store).<br /><br />Glitho is also considering how existing sensor technology, capable of measuring space, temperature, environment or luminosity, might be used in cellphones in everyday situations. For example, sensors might be able to detect the maturity of produce. <br /><br />Glitho has written more than 100 peer-reviewed papers and earned 24 patents (with several pending applications) in communications-related areas in his positions in the industry (he worked at Ericsson for over 25 years) and academia (Glitho is an adjunct professor at the Institut de Mathématiques et de Sciences Physiques at the Université d'Abomey-Calavi in his home country of Benin).<br /><br />Glitho was among five Concordia scientists who received support from the Canada Research Chair (CRC) program in November. Over five years, the university will receive $500,000 for each CRC.<br /><br /><b>Related Links:</b><br /> ⬢&nbsp;&nbsp;&nbsp; <a href="http://users.encs.concordia.ca/%7Etse/">Concordia's 
Telecommunications Service Engineering Lab </a><br /> ⬢&nbsp;&nbsp;&nbsp; <a href="http://now.concordia.ca/what-we-do/research/20101124/new-funding-for-canada-research-chairs.php">New
 funding for Canada Research Chairs</a> - Now, November 24, 2010<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/01/engineering-new-uses-for-smartphones.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Engineering new uses for smartphones
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/01/engineering...hones.php </p>
