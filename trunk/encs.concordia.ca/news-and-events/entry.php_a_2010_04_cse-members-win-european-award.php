...
<head>
	...
	<title>
CSE Members win European award
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F04%2Fcse-members-win-european-award.php','%0ACSE%20Members%20win%20European%20award%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/04/cse-members-win-european-award.php#maincontent" accesskey="s">Skip to Content</a></li>
...
CSE Members win European award
			...
			<div class="entry-meta" title="2010-04-08T12:49:22-05:00">Thursday Apr  8, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
Concordia's Faculty of Engineering and Computer Science is pleased to announce that <a href="http://users.encs.concordia.ca/%7Ebui/">Dr. Tien Bui</a> and his graduate student <a href="http://users.encs.concordia.ca/%7Ed_cho/">Dongwook Cho</a>, both from the <a href="http://www.cs.concordia.ca/">Department of Computer Science and Software Engineering</a>, have been selected as recipients of the 2010 Signal Processing: Image Communication Best Paper Award from the European Association for Signal Processing (<a href="http://www.eurasip.org/">EURASIP</a>). <br /><br />Dr. Bui and Dongwook Cho co-authored the winning paper, entitled "Multivariate statistical modeling for image denoising using wavelet&nbsp; transforms." It was published in Volume 20 of the peer-reviewed journal, <i>Signal Processing: Image Communication</i>, and was singled out for the award, which honours papers published in the 4-year period between 2005 and 2008, by a technical award sub-committee of EURASIP. <br /><br />The award consists of a certificate and cash award of 1000 Euros for the authors, who hope to attend the awards ceremony in Denmark during the 18th European Signal Processing Conference (<a href="http://www.eusipco2010.org/">EUSIPCO</a>) this August. <br /><br />The paper is based on the Master's thesis of Dongwook Cho, which was published as a book by VDM Verlag in Germany. Cho's other related work was also chosen in 2005 as one of the top 20 science and engineering projects in Quebec Universities for the first National Science and Engineering Forum. <br /><br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/04/cse-members-win-european-award.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
CSE Members win European award
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/04/cse-members...award.php </p>
