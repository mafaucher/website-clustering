...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Ffaculty-magazine%2Farticle%2F%3Fa%3D2010%2F10%2Fresearch-in-action.php','%0AResearch%20in%20Action%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2010/10/research-in-action.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<img alt="Hoa3.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Hoa3.jpg" class="mt-image-right" style="float: right; margin: 0pt 0pt 20px 20px;" height="346" width="220" />You need only peek into Dr. Suong Van Hoa's office to know that he's a busy man. A desk piled high with journals and papers, a wall crammed with awards, scale models of helicopter and airplane parts, and several computers humming away all indicate that this is a professor who is on the go 24/7.<br /><br />Lately, the days are particularly busy for this Professor from the Department of Mechanical and Industrial Engineering, as the Faculty of Engineering and Computer Science is gearing up for a renewed offensive in aerospace research and development. As the Director of the Concordia Centre for Composites, Dr. Hoa's research interests are helping the Faculty to remain a leader in the field by focusing on the use and manufacture of high-tech materials known as composites that are revolutionizing the aerospace industry.<br /><br />Boiling his complex work into a succinct description, Dr. Hoa explains, "it's all about very small, very strong materials." Composites are mostly made up of microscopic carbon or glass fibres, bound together with a resin and then shaped into whatever form a given project demands. "Composites are the hot new trend in aviation," says Dr. Hoa, citing the Airbus 380 and Boeing 787--the world's largest planes--as prime examples of this. "These companies use composites because you can shape the material into exactly the form that is needed, rather than machining it, thus saving the company a lot in terms of time and labour." <br /><br />Dr. Hoa was awarded significant funding last year from the Canada Foundation for Innovation to support his research into composites. He is now using the funds provided by the grant to purchase a cutting-edge piece of equipment known as an automated fibre placement machine that will allow him to automate the fabrication of composites--a process formerly done manually using a time-consuming technique. "Ever since composites have been used in the aerospace industry," Hoa explains, "they have been produced using the hand lay-up technique, laying one sheet of woven carbon fibres and resin atop another by hand." The industry previously required so many custom-made parts that a manual approach was the most sensible. Now, with production on a more massive scale, the move towards automation is key in both research and development, as it will allow experiments to have repeatability and limit the waste of materials, all while leading to improved quality.<br /><br />"The industry has already made the jump to automation," says Hoa. "Now it's up to us to catch up." Acquiring an automated fibre placement machine specifically for research here at Concordia will make this the first university in Canada to possess this cutting-edge equipment, positioning the Faculty of Engineering and Computer Science at the forefront of aerospace research. <br /><br />This machine will feature two robots that can "dance together" in the automated fibre placement process. These robots will be used specifically to help test the more ductile "thermoplastic" material that seems set to replace the rigid "thermoset" composites that have been the industry standard. The equipment will also be used to help smaller aerospace companies perform research into production and design while giving students from programs such as the Concordia Institute of Aerospace Innovation and Design hands-on experience. "This can be a service platform for companies to come out and try the technology. We can also do a cost-comparative study and ask questions such as, 'is this new material or this new equipment better in terms of cost, efficiency, or production?' We can help them get answers before they make their big investment," says Hoa.<br /><br />With Concordia at the vanguard of university-based aerospace research and development, the next step is to establish an NSERC industrial chair in the area. With the help of Dr. Robert Fews, the Faculty's Special Aerospace Advisor, and the full support of Dean Robin Drew, Dr. Hoa is working on the complex application process. The hope is that the Natural Sciences and Engineering Research Council will provide the Faculty with funding over a 5-year period, thus helping attract a successor for Dr. Hoa while continuing to build on the aerospace research infrastructure here at Concordia. With any luck, funding will be secured in spring of 2011 and the new Chair will be in place by the following fall. <br /><br />Although he speaks of retiring "in a few years," it is hard to imagine Dr. Hoa slowing down: much like the research he carries out on a day-to-day basis, he seems poised to take off into the future.<br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2010/10/research-in-action.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
