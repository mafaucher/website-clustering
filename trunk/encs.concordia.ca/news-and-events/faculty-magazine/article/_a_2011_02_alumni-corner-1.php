...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Ffaculty-magazine%2Farticle%2F%3Fa%3D2011%2F02%2Falumni-corner-1.php','%0AAlumni%20Corner%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2011/02/alumni-corner-1.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Get Connected </a>
	...
	<div id="maincontent"  class="topgutter"  >
		<div id="lh_menu_area">
		<div id="lh_menu">
<ul class="level_3"><li id="li_Fall2011_4"><a href="../issue.php_q_Fall_y_2011"><span>Fall 2011</span></a></li><li id="li_Summer2011_4"><a href="../issue.php_q_Summer_y_2011"><span>Summer 2011</span></a></li><li id="li_Winter2011_4"><a href="../issue.php_q_Winter_y_2011"><strong><span>Winter 2011</span></strong></a></li><li id="li_Fall2010_4"><a href="../issue.php_q_Fall_y_2010"><span>Fall 2010</span></a></li><li id="li_Spring2010_4"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/issue.php?q=Spring&y=2010"><span>Spring 2010</span></a></li><li id="li_Winter2010_4"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/issue.php?q=Winter&y=2010"><span>Winter 2010</span></a></li></ul></div>
	</div>
		<div class="insidecontent ">

			<p class="breadcrumb"><a href="../../../index.html">ENCS Home</a> &gt; <a href="../index.php">News &amp; events</a> &gt; <a href="index.php">Faculty Magazine</a> &gt; <a href="../issue.php_q_Winter_y_2011">Winter 2011</a> &gt;</p>
...
<img alt="Alumni.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Alumni.jpg" class="mt-image-left" style="float: left; margin: 0pt 20px 20px 0pt;" height="288" width="220" />Advanced research is the province not only of universities, but also of industry. For Christopher Labrador, industrial innovation is both a fact of the job and a source of inspiration. As Vice President of Advanced Research for Research in Motion, Labrador spends his days at the cutting edge of new technology. As a graduate of Concordia's Department of Computer Science and Software Engineering, Labrador knows firsthand the extensive scholarly work that can often drive industrial innovation.<br /><br />Decisive action is a hallmark of Labrador's career. As an undergraduate, he was driven to succeed. Under the supervision of Thiruvengadam Radhakrishnan, Labrador excelled and went on to begin a master's degree. With great grades, an impressive scholarship, and constant academic stimulation, Labrador thought he was headed towards a doctorate and even had an offer from Carnegie Mellon. But when industry came calling just as he was writing up his thesis, he couldn't refuse the opportunity. <br /><br />The idea that he could do the kind of work that interested him, get paid for it, and acquire all the equipment necessary to carry out that work was too appealing to pass up. So Labrador left the academe for Bell Northern Research. "Off I went on my big adventure," jokes Labrador, whose career took him and his growing family to places such as Ottawa, Halifax, Florida, North Carolina, Kansas and Texas. <br /><br />Over the years, Bell Northern Research was absorbed into Nortel Networks, and Labrador's work kept advancing. "I went from being just a regular old programmer to being a VP responsible for about $2.5 billion worth of sales," he recalls with a smile. Always one with his finger on the pulse of the industry, Labrador left Nortel in 2000, just before things began to head south for the company. "I was just really lucky," he shrugs. <br /><br />Labrador then started up his own business, a company called nVsible Networks, whose motto was "bandwith without boundaries." But after a few years going it alone in an uncertain market, he and his partner cut their losses and dissolved the company. Ever resilient, Labrador joined Toshiba in California as the company's Digital Solutions Division Vice President of Product Management &amp; Technology. He remained with the company for three years, eventually leaving to pursue other opportunities. <br /><br />In 2006, Research in Motion came calling. The fit couldn't have been better. Labrador moved back to Canada and became the company's Vice President of Product Management for Wi-Fi Products and Collaborative Voice Solutions, a position he held for three years before being made Vice President of Advanced Research. "This is the most fun I've ever had on a job--it's certainly the most interesting work I've ever done," says Labrador. He goes on to explain, "my job is to find out what's missing to solve tomorrow's problems, and then figure out how to go and get that missing piece." Labrador's eyes light up when he talks about his work. "Some of the projects I'm working on today would blow peoples' socks off," he says, listing such fascinating topics as virtual retinal displays, homomorphic encryption, quantum encryption devices...the list of innovative areas seems endless. <br /><br />Labrador is understandably optimistic about the future and looks forward to all the work still ahead of him. Ever curious about advancing research, he now sits on the scientific advisory board for a Natural Sciences and Engineering Research Council of Canada project called Healthcare Support through Information Technology Enhancements, or hSITE. The government-funded network seeks to develop an IT infrastructure that can support the complex requirements of a clinical environment. "Mobile health is set to be a big thing," Labrador explains, "and I'm having a blast being part of it." Although he can't yet discuss the details, Labrador is particularly excited about his involvement in a project that could have a major impact on how diabetes is managed. <br /><br />For Labrador, the past 50 years was just the beginning. "I figure I'm going to live to be well over 100," he says. Not planning to retire to a life of leisure, he hopes instead to go back to school at some point down the road. "Actually, I'm thinking about going to medical school," says Labrador with the confidence of a man used to achieving his goals. "Not to treat patients, but to diagnose diseases by applying all that technology I have under my belt." If this Concordia graduate does indeed become part of the medical establishment, perhaps we can all count on living past 100.<br /><br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2011/02/alumni-corner-1.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Alumni Corner
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/index...ner-1.php </p>
