...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Ffaculty-magazine%2Farticle%2F%3Fa%3D2010%2F05%2Fstaff-profile.php','%0AStaff%20Profile%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2010/05/staff-profile.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Get Connected </a>
	...
	<div id="maincontent"  class="topgutter"  >
		<div id="lh_menu_area">
		<div id="lh_menu">
<ul class="level_3"><li id="li_Fall2011_4"><a href="../issue.php_q_Fall_y_2011"><span>Fall 2011</span></a></li><li id="li_Summer2011_4"><a href="../issue.php_q_Summer_y_2011"><span>Summer 2011</span></a></li><li id="li_Winter2011_4"><a href="../issue.php_q_Winter_y_2011"><span>Winter 2011</span></a></li><li id="li_Fall2010_4"><a href="../issue.php_q_Fall_y_2010"><span>Fall 2010</span></a></li><li id="li_Spring2010_4"><a href="../issue.php_q_Spring_y_2010"><strong><span>Spring 2010</span></strong></a></li><li id="li_Winter2010_4"><a href="../issue.php_q_Winter_y_2010"><span>Winter 2010</span></a></li></ul></div>
	</div>
		<div class="insidecontent ">

			<p class="breadcrumb"><a href="../../../index.html">ENCS Home</a> &gt; <a href="../index.php">News &amp; events</a> &gt; <a href="index.php">Faculty Magazine</a> &gt; <a href="../issue.php_q_Spring_y_2010">Spring 2010</a> &gt;</p>
...
<p><strong><em>Guy Gosselin, Manager of Building Operations</em></strong></p>
<p><img style="MARGIN: 0px 0px 20px 20px; FLOAT: right" class="mt-image-right" alt="Guy_0008.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Guy_0008.jpg" width="220" height="331" />"I love my job" is a statement that many people would love to hear themselves say. When this assertion comes out of Guy Gosselin's mouth, you know he means it. Having been an integral part of the Faculty of Engineering and Computer Science for over 25 years, Gosselin knows this Faculty like the back of his hand.</p>
<p>He started here as a bright eyed 22-year old recently out of CEGEP, where he trained as an electronic technologist, and with two years of working in industry already under his belt. He began as a technician in the Department of Electrical and Computer Engineering. "The job was challenging and a lot of fun," recalls Gosselin who enjoyed working with the lab equipment to ensure it was functional for the various classes within the department. </p>
<p>Then came an enrolment boom, which saw student numbers increase across the board. With more students came improved facilities and upgraded equipment.&nbsp; "It was like Christmas for us!" Gosselin says with a smile. By this point, it was the late 90s and he had become a group leader, charged with overseeing the renovation project that saw the transformation of the 8th floor of the Hall Building. It was during this project that Gosselin became Technical Officer for ECE, overseeing the work of the other technicians. He took the new roll in his stride.<br />While the major renovations were going on in the Hall Building, talks began regarding the creation of the new Engineering pavilion--what would eventually become the EV Building.</p>
<p>Gosselin was delighted to see the Faculty's pride of place. "It was the first time there was really the feeling of a unified vision," he explains. "At one point I saw some artistic renderings of the new designs and realized that this was a major departure from what the Hall Building used to be and was a great step in putting the Faculty's stamp on the campus. For 20 years I had worked on the 8th floor and that was like a revolution for me."</p>
<p>The renovation project was "a blast," remembers Gosselin, who worked closely with planners and architects, getting to know the project management aspect of such an undertaking.&nbsp; It seemed logical, then, that he become involved at the Faculty level in the construction of the EV Building. "At first I was told this would be a temporary position while the EV Building was constructed!" laughs Gosselin, who has now held this job for nearly 6 years.&nbsp; "It was a huge responsibility but at the same time I was thrilled. I had no clue how far reaching this would be when I started but at the same time I took it as a challenge, something to learn from." </p>
<p>Although the EV Building is now completed, Gosselin's job still keeps him active and on his toes. "At the moment," says Gosselin, "we're working hard on the 10th floor of the Hall Building: it's in need of renovation, so we're going to consolidate the mechanical engineering teaching labs in that space. The labs are currently scattered all over the place so this centralization is going to be a great improvement." The project is planned to be completed and functional by summer 2011.</p>
<p>Gosselin has witnessed this Faculty's evolution under the leadership of four different Deans. He's seen the Faculty through periods of growth and recession, has welcomed new staff members and said goodbye to old friends, and he has seen his own role within ENCS expand and evolve over his quarter century here.&nbsp; Ask him what's next and you'll get a characteristic smile and shrug of the shoulders. "10 years from now, I have no clue where I'll be! But I'd certainly be happy to find myself still part of this Faculty. I've got a great job and this is a great place to work. There's always the adrenaline, there's always something, there are always interesting new challenges to take on."</p>
<p align="right"><em>Photo by Marc Bourcier.</em></p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2010/05/staff-profile.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Staff Profile
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/index...ofile.php </p>
