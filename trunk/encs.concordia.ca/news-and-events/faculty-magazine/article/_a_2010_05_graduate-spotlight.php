...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Ffaculty-magazine%2Farticle%2F%3Fa%3D2010%2F05%2Fgraduate-spotlight.php','%0AGraduate%20Student%20Spotlight%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2010/05/graduate-spotlight.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<p><i><b>Serguei Mokhov, PhD Candidate in Computer Science</b></i><br /><br /><b><img style="MARGIN: 0px 20px 20px 0px; FLOAT: left" class="mt-image-left" alt="Sergui_0015.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Sergui_0015.jpg" width="220" height="404" />What's your background?</b><br />I was born and raised in Russia, and began my university studies at the <a href="http://www.eltech.ru/english/index.htm">St. Petersburg State Electrotechnical University</a>. After two years there, I transferred to Concordia, where I've been studying ever since.<br /><br /><b>How did you first become interested in studying computer science?</b><br />Computers have been second nature to me ever since I saw my first one back in middle school. Like many other proud nerds, my interest began with computer games but grew over time to encompass a scientific and engineering aspects, application development, and system administration.<br /><br /><b>Why did you choose Concordia?</b><br />I came to Canada in 1998, with my parents and younger brother in search of opportunities and a better life. Coming to Canada opened up so many doors and opportunities! Concordia became one of those opportunities, what with the excellent reputation of the computer science program. Back in Russia, I never could have dreamed I'd be working, doing research, and especially teaching in English at a Canadian university!<br /><br /><b>What is your research focus?</b><br />My tentative thesis title is "Intensional Cyberforensics." The project is being supervised by Drs. <a href="http://newton.cs.concordia.ca/~paquet/wiki/index.php/Main_Page">Joey Paquet</a> of <a href="http://www.cse.concordia.ca/">CSE</a> and <a href="http://www.cse.concordia.ca/">Mourad Debbabi </a>of the <a href="http://www.ciise.concordia.ca/">CIISE</a>, who are experts in intensional programming and forensic computing respectively. My thesis uses the intensional programming paradigm to specify digital forensics cases, evaluate and reason about them. That means I am using the Forensic Lucid specification language to model a digital crime scene, accompanying digital evidence, and witness accounts. Through the execution of what's called a Forensic Lucid program I then verify if a certain claim agrees with the modeled evidence. If it does, I then reconstruct the most complete and trustworthy sequence of events available that explain the claim.<br /><b><br />How else have you been involved with the Concordia community?</b><br />Over the years, I've become very involved in ENCS, both as a member of staff and part-time faculty. I've been involved in various units of the Faculty's <a href="../../../administration-and-governance/administrative-units/academic-information-technology-services/index.html">Academic and Information Technology Services</a> and have also taught both graduate and undergraduate classes within CSE. On the recreational side of things, I was involved as a paddler on Concordia's dragon boat team, serving as captain for a season--it was a great experience, though very demanding.<br />&nbsp;<br /><b>What are your plans after graduation?</b><br />I will likely stay at AITS for a few years to come, and also hope to continue teaching and doing research in collaboration with ENCS faculty members. I am also seriously considering doing a post-doc, though I'll likely take a bit of a break to dedicate more time to my wife and two young children.<br /><br /><b>Where do you see yourself in 10 years?</b><br />That's the million dollar question! My current career path can either lead me towards further hands-on IT work or towards academic and research and teaching. Regardless of what I choose, I plan to continue to contribute to Concordia and its students in one way or another for years to come.</p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2010/05/graduate-spotlight.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
