...
<head>
	...
	<title>
CSE Professor presented with honorary award
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F09%2Fcse-professor-presented-with-honorary-award.php','%0ACSE%20Professor%20presented%20with%20honorary%20award%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/09/cse-professor-presented-with-honorary-award.php#maincontent" accesskey="s">Skip to Content</a></li>
...
CSE Professor presented with honorary award
			...
			<div class="entry-meta" title="2011-09-08T14:41:39-05:00">Thursday Sep  8, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="doedel-eusebius.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/doedel-eusebius.jpg" class="mt-image-left" style="float: left; margin: 0pt 20px 20px 0pt;" width="200" height="250" /><a href="http://cmvl.cs.concordia.ca/doedel.html">Eusebius Doedel</a>, Professor in the <a href="http://www.cse.concordia.ca/">Department of Computer
Science and Software Engineering</a><div><p class="MsoNormal"> received an honourary award in recognition of
his significant contributions to the computational dynamics area from a
subdivision of the American Society of Mechanical Engineers (ASME), a society
founded in 1880 with the goal of promoting the art, science and practice of
mechanical and multidisciplinary engineering and allied sciences to the diverse
communities throughout the world.</p>

<p class="MsoNormal">The ASME's Technical Committee on Multibody Systesm and
Nonlinear Dynamics, which is part of the Design Engineering Division,
established honorary awards in order to provide an opportunity for the
community to express its appreciation to the leading researchers who, in
addition to their research contributions, have also trained generations of
engineers and researchers in the fields of multibody systems and nonlinear
dynamics.</p>

<p class="MsoNormal">The award was officially presented at the Eight ASME
International Conference on Multi-Body Systems, Nonlinear Dynamics, and
Control, held in Washington DC August 28-31 2011 and attended by leading
researchers in the field. Contratulations, Professor Doedel! </p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/09/cse-professor-presented-with-honorary-award.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
CSE Professor presented with honorary award
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/09/cse-profess...award.php </p>
