...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F02%2Fjournal-honours-nabil-esmail.php','%0AJournal%20honours%20Nabil%20Esmail%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/02/journal-honours-nabil-esmail.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Journal honours Nabil Esmail
			...
			<div class="entry-meta" title="2011-02-17T10:03:01-05:00">Thursday Feb 17, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="APJCE.gif" src="http://newsfeed.encs.concordia.ca/encs_test/APJCE.gif" class="mt-image-left" style="margin: 0pt 20px 20px 0pt; float: left;" height="131" width="101" /><div>The Asia Pacific Journal of Chemical Engineering has published a special edition honouring Dr. Nabil Esmail, former Dean of the Faculty of Engineering and Computer Science.<br /><br />The journal, which honours Professors Esmail's "remarkable contributions to Chemical Engineering science and its
international community," can be viewed online <a href="http://onlinelibrary.wiley.com/doi/10.1002/apj.v6.1/issuetoc">here</a>. <br /><br />Dr. Mourad Debabbi, Director of the Concordia Institute for Information Systems Engineering, states that this honour "nicely
complements all Professor Esmail's other achievements over the past years
in academic management and leadership." A sentiment amply echoed by many in the Faculty.</div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/02/journal-honours-nabil-esmail.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Journal honours Nabil Esmail
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/02/journal-hon...smail.php </p>
