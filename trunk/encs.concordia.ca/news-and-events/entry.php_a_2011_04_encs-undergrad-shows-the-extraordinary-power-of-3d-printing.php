...
<head>
	...
	<title>
 ENCS undergrad shows the power of 3D printing
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F04%2Fencs-undergrad-shows-the-extraordinary-power-of-3d-printing.php','%0A%20ENCS%20undergrad%20shows%20the%20power%20of%203D%20printing%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/04/encs-undergrad-shows-the-extraordinary-power-of-3d-printing.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<!-- InstanceBeginEditable name="maincontent" --><!-- FCKEDITOR_maincontent --><!-- /FCKEDITOR_maincontent -->
 ...
 ENCS undergrad shows the power of 3D printing
			...
			<div class="entry-meta" title="2011-04-14T10:12:02-05:00">Thursday Apr 14, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<font style="font-size: 0.8em;"><i>Originally posted on Concordia Now - by: Russ Cooper</i></font><br /><br />Three-dimensional printing has the potential to change how products are designed, manufactured and consumed.<br /><br /><a href="http://newsfeed.encs.concordia.ca/encs_test/gavin.jpg"><img alt="gavin.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/assets_c/2011/02/gavin-thumb-132x187-291.jpg" class="mt-image-right" style="float: right; margin: 0pt 0pt 20px 20px;" width="132" height="187" /></a>This was the idea at the centre of a presentation given by third-year Mechanical and Industrial Engineering student Gavin Kenneally to engineering faculty and students on April 6.<br /><br />3D printing technology -- which "prints" an object, instead of a two-dimensional image, one layer at a time -- has existed since the 1980s, but has required bulky, expensive machines that use its primary publishing material&nbsp; plastic powders that yield fragile products.<br /><br />Now, Kenneally says, 3D printing equipment is getting smaller and less expensive and can handle different and more durable materials, such as stainless steel and glass. He points to recent work at Cornell University that has tested printing electrically-conductive materials, and researchers at Wake Forest University in North Carolina who are even experimenting with the 3D printing of human organs.<br /><br />3D printing hardware can be constructed using open-source files found online as a blueprint -- something Kenneally himself did with the 3D printer that sits on his desk at home.<br /><br />With this "sea change of manufacturing and design," Kenneally says a smart and resourceful designer can complete every step of the production process -- serving not only as designer, but also engineer, manufacturer, distributor, product tester, and end-user.<br /><br />Kenneally says this concept and technology has many benefits, including the potential to reduce waste or eradicate lengthy shipping bottlenecks at borders. Eventually it might even create a perfectly fitting pair of shoes custom-moulded for one's feet.<br /><br />This was the same message he had delivered at the TEDxConcordia event this past February. Based on TED Talks, the events feature speakers presenting, in the words of the originators, "ideas worth spreading". Kenneally's post-TEDxConcordia Faculty talk was more technical albeit, to reflect the audience's engineering savvy.<br /><br />He was invited to give the repeat performance to Concordia's engineering community by Mechanical and Industrial Engineering professor Paula Wood-Adams, who has been supervising his research into 3D printing since September.<br /><br />Design and engineering, says Kenneally, "might seem like the two fields that are separate or exclusive, but there's so much crossover. I like to present them as if they're one and the same."<br /><br />"Gavin is doing and learning so much more by making use of the university, the people, the facilities and opportunities such as TEDx," says Wood-Adams. "To me, this is a perfect example of getting every possible bit out of an undergraduate education."<br /><br />This summer, Kenneally will be interning at the University of Pennsylvania. He'll be working in the General Robotics, Automation, Sensing and Perception (GRASP) Laboratory, one of the United States' best-known laboratories for biomimetics -- the study and development of synthetic systems that mimic biologically-produced substances, materials, mechanisms and processes.<br /><br />Kenneally will return to Concordia this fall for the fourth year of his degree.<br /><br />To fully understand the power of 3D printing, watch Gavin Kenneally's presentation at TEDxConcordia, February 19, 2011 at the Eric Maclean S.J. Centre for the Performing Arts near the Loyola Campus:<br /><iframe title="YouTube video player" src="http://www.youtube.com/embed/e4k8efb0vUI?rel=0" allowfullscreen="" width="440" frameborder="0" height="278"></iframe>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/04/encs-undergrad-shows-the-extraordinary-power-of-3d-printing.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
 ...
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/04/encs-underg...nting.php </p>
