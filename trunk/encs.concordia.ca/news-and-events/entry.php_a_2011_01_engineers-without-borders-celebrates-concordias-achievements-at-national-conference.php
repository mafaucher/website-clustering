...
<head>
	...
	<title>
Engineers Without Borders celebrates Concordia's achievements at national conference
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F01%2Fengineers-without-borders-celebrates-concordias-achievements-at-national-conference.php','%0AEngineers%20Without%20Borders%20celebrates%20Concordia%27s%20achievements%20at%20national%20conference%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/01/engineers-without-borders-celebrates-concordias-achievements-at-national-conference.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Engineers Without Borders celebrates Concordia's achievements at national conference
			...
			<div class="entry-meta" title="2011-01-19T11:08:19-05:00">Wednesday Jan 19, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
Delegates from Concordia's Faculty of Engineering and Computer Science were pleased to be part of the 2011 Engineers Without Borders Conference, which took place in Toronto from January 13 through 15, 2011. The event marked the tenth anniversary of the Canadian arm of the international organization, which has long had close ties to Concordia.<br /><br /><div align="center"><img alt="EWB-Conference-web.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/EWB-Conference-web.jpg" class="mt-image-center" style="text-align: center; display: block; margin: 0pt auto 20px;" height="282" width="440" /><font style="font-size: 0.8em;"><i>Concordia's delegates at the EWB conference in Toronto</i><br /></font></div><br />Present from the University's Faculty of Engineering and Computer Science was a team of 19 individuals, including Robin Drew (Dean of the Faculty of Engineering and Computer Science), Deborah Dysart-Gale (Chair of the General Studies Unit), Govind Gopakumar (Assistant Professor&nbsp; in the General Studies Unit), and Jad Saleh (President of the Concordia Chapter of Engineers Without Borders). Faculty alumni were even involved: former valedictorian and "EWB-er" Meagan Putnam pitched in to help with the event's logistics and was delighted to help out the inspirational organization.<br /><br />In keeping with the conference's theme of "Global Engineering," Dysart-Gale and Gopakumar gave a special presentation to a closed-door session of deans and administrators on the role of complementary studies in developing social and global awareness among engineering students. They also participated in a faculty-specific curriculum change workshop with about 20 engineering faculty from across Canada. The workshop identified challenges to the integration of social awareness into engineering education, and considered ways to creatively bring these concerns into the curriculum.<br /><br />The student delegates were also very involved with the proceedings of the conference: Concordia's EWB Chapter was thrilled to be selected amongst 33 nominees for the Most Improved Chapter of the Year Award, marking the first such win in the Chapter's 8-year history.&nbsp; The Concordia EWB Chapter also won the Best Project Award during the innovation forum, selected as the best out of 65 projects from across Canada. The winning project, known as "Sister Schools," is a joint collaboration with McGill University, and was awarded $500 in support funds. For more on the project, visit <a href="http://www.encs.concordia.ca/news-and-events/www.concordia.ewb.ca/sisterschools">www.concordia.ewb.ca/sisterschools</a>.<br /><br />Another shining moment came when it was officially announced that Concordia's Faculty of Engineering and Computer Science had become the first Fair Trade Certified Faculty in Canada--a statement that garnered a loud cheer from the crowd&nbsp; of over 1200! <br /><br />The event wrapped up with a bang: the gala soirée featured an unforgettable evening of African music, cuisine, entertainment and passion. It was the perfect way to mark a milestone birthday--and to look forward to further decades of such celebration.<br /><br />To learn more about the groundbreaking projects of Engineers Without Borders Canada, visit: their <a href="http://www.ewb.ca/en/index.html">official website</a>.<br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/01/engineers-without-borders-celebrates-concordias-achievements-at-national-conference.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Engineers Without Borders celebrates Concordia's achievements at national conference
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/01/engineers-w...rence.php </p>
