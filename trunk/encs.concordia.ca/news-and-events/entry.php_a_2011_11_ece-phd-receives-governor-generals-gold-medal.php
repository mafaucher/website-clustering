...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F11%2Fece-phd-receives-governor-generals-gold-medal.php','%0AECE%20PhD%20receives%20Governor%20General%27s%20Gold%20Medal%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/11/ece-phd-receives-governor-generals-gold-medal.php#maincontent" accesskey="s">Skip to Content</a></li>
...
ECE PhD receives Governor General's Gold Medal
			...
			<div class="entry-meta" title="2011-11-17T09:46:31-05:00">Thursday Nov 17, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="Mehdipour.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Mehdipour.jpg" class="mt-image-right" style="float: right; margin: 0 0 20px 20px;" height="224" width="325" />Graduate student Aidin Mehdipour, from the Department of Electrical and Computer Engineering, will receive the Governor General's Academic Gold Medal at Concordia's convocation ceremonies on November 22. He recently completed his PhD thesis entitled, Advanced Carbon-Fiber Composite Materials for Shielding and Antenna Applications, under the supervision of C.W. Trueman and A.R. Sebak.<br /><br />The Governor General's Academic Gold Medal recognizes Mehdipour's significant research accomplishments. Gold medals are awarded to graduate students in two key areas outlined in the university's Strategic Research Plan: The Person and Society (awarded during spring convocation); and Technology, Industry and the Environment (awarded during fall convocation).<br /><br />Mehdipour's thesis "is one of the most significant and comprehensive research works ever done on electromagnetic characteristics of composite materials, which is very important for avionic and spacecraft industries," says Suong Van Hoa, director of the Concordia Centre for Composites.<br /><br />Mehdipour began his research investigating the electromagnetic properties of carbon composite compared to aluminum as a shield against electromagnetic radiation on modern aircraft. Carbon composite is used instead of aluminum because it is lighter and stronger. His research was part of a joint project between Concordia, √0cole Polytechnique de Montr√©al and Bell Helicopter, and funded in part by the Natural Sciences and Engineering Research Council of Canada.<br /><br />"After doing this project, I decided to try using composite materials for antenna microwave applications, because I saw there was potential there," says Mehdipour. "It was a very new area, untouched."<br /><br />Antennas made with composite materials can function in climates where metal is unsuitable. "The composite material shows very good corrosion resistance," he says. "Many people call them green antennas. Because of their resistance to corrosion and fantastic mechanical characteristics, it could be used in harsh environments, for military applications or any application outdoors."<br /><br />Mehdipour praises Concordia and his professors for supporting his research. "My supervisors supported me very well," he says. "They spent a lot of time reviewing my work, and whenever I needed some components we didn't have, they purchased them. In microwave research, the components are expensive!"<br /><br />Although Mehdipour has now graduated from Concordia, he continues to work on several projects, and recently submitted a patent application. "I still have many projects that I'm working on in my free time, specifically the patent issue, it's not a short-term project," he says. 
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/11/ece-phd-receives-governor-generals-gold-medal.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
ECE PhD receives Governor General's Gold Medal
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/11/ece-phd-rec...medal.php </p>
