...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2009%2F09%2Fciise-researcher-merits-long-term-funding-from-crc-program.php','%0ACIISE%20researcher%20merits%20long%20term%20funding%20from%20CRC%20program%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/09/ciise-researcher-merits-long-term-funding-from-crc-program.php#maincontent" accesskey="s">Skip to Content</a></li>
...
CIISE researcher merits long term funding from CRC program
			...
			<div class="entry-meta" title="2009-09-23T16:37:36-05:00">Wednesday Sep 23, 2009</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
Concordia Institute for Information Systems Engineering's <b>Professor Yong Zeng</b> has seen the quality of his research recognized with further Tier-2 funding of $100,000 each year over a five year period from the Canada Research Chairs (CRC) program.&nbsp; Professor Zeng is reconfirmed as the <a class="zem_slink" href="http://www.chairs.gc.ca/" title="Canada Research Chair" rel="homepage">Canada Research Chair</a> in Design Science. The Honorable Gary Goodyear, Minister of State (Science and Technology), announced the news this morning at the University of Guelph recognizing&nbsp; one hundred and eighty one (181) appointments and renewals of Canada Research Chairs.<br /><br />Professor Yong Zeng's research focuses on establishing a design science that helps develop tools and shorten the development time of new products.&nbsp; Professor Zeng's work develops scientific methods to study the fundamental principles governing the complex area of design activities.&nbsp; His findings can be used in the manufacturing of aerospace, automotive and medical devices and in national defense.&nbsp; Currently, approximately 80 percent of the costs associated with the development of new products can be traced back to decisions made in the product design stage.&nbsp; Professors Zeng's research aims to reduce the significant proportion of product recalls now caused by faulty product design. &nbsp;<br /><br />"This announcement is a solid endorsement of the continued excellence of Concordia University researchers' work," says Concordia's President and Vice-Chancellor, <b>Judith Woodsworth</b>.&nbsp; "Professor Zeng's advances in computer-aided design will help position this country's manufacturers in an increasingly competitive global business environment." 
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/09/ciise-researcher-merits-long-term-funding-from-crc-program.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
CIISE researcher merits long term funding from CRC program
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2009/09/ciise-resea...ogram.php </p>
