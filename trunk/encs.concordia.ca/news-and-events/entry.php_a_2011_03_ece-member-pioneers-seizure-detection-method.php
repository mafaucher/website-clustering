...
<head>
	...
	<title>
ECE member pioneers seizure detection method
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F03%2Fece-member-pioneers-seizure-detection-method.php','%0AECE%20member%20pioneers%20seizure%20detection%20method%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/ece-member-pioneers-seizure-detection-method.php#maincontent" accesskey="s">Skip to Content</a></li>
...
ECE member pioneers seizure detection method
			...
			<div class="entry-meta" title="2011-03-24T10:56:30-05:00">Thursday Mar 24, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<font style="font-size: 0.8em;"><i>by Chris Atack</i></font><br /><br />Researchers at Concordia University's Faculty of Engineering and Computer Science have pioneered a computer-based method of detecting epileptic seizures - a method which may open new windows on the brain's electrical activity. Their <a href="http://ieeexplore.ieee.org/xpl/freeabs_all.jsp?reload=true&arnumber=5626781">research paper</a>, "A Novel Morphology-Based Classifier for Automatic Detection of Epileptic Seizures," presented at the annual meeting of the Engineering in Medicine and Biology Society, documents the very successful application of this new method of seizure detection.<br /><br /><div align="center"><img alt="seizure.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/seizure.jpg" class="mt-image-center" style="text-align: center; display: block; margin: 0pt auto 20px;" height="204" width="440" /><font style="font-size: 0.8em;"><i>In this image of an EEG scan supplied by Rajeev Agarwal, the onset of 
the seizure is visibly evident across several channels.</i></font><br /></div><br />An epileptic seizure - caused by disruptions in the normal electrical activity of the brain - can produce a range of symptoms including convulsions and unconsciousness. To learn more about the timing and nature of seizures, the electrical activity of patients' brains is often recorded using electroencephalograms (EEGs). At the moment, however, epilepsy experts must review these recordings manually - a time-consuming process.<br /><br />"EEG recordings may cover a period of several weeks," explains study co-author <a href="http://www.encs.concordia.ca/resources/faculty-and-staff-directory/details/?id=Agarwal,%20Rajeev&d=03">Rajeev Agarwal</a>, a professor in Concordia's <a href="http://www.ece.concordia.ca/">Department of Electrical and Computer Engineering</a>. "That's a lot of data to review. Automating the process is difficult, because there's no exact definition for a seizure, so there's no template to look for. Every seizure is different with every patient."<br /><br />However, seizures have certain recognizable characteristics. They occur when neurons fire in a synchronous or rhythmic manner. As seizures progress, the EEG signals have very strong transitions. Seen on an EEG recording, the waves of electrical activity tend to spike, rather than curve. Knowing this, the Concordia team, led by PhD candidate and lead study author <a href="http://users.encs.concordia.ca/%7Er_yadav/">Rajeev Yadav</a>, devised an algorithm to check the "sharpness" of the electrical signals on the EEG recordings as measured by their angle or slope. A series of sharp signals indicates a seizure.<br /><br />This approach proved extremely successful. In the study of EEG recordings of seven patients, the new method detected every seizure while scoring an extremely low rate of false positives. Results are far better than those obtained with existing methods.<br /><br />This approach to detecting seizures may have applications beyond epilepsy. "Patterns of sharp electrical activity in the brain are generally not a good thing," says Agarwal. "Think of comatose patients in the ICU for example. Some of them may be having seizures or epileptic form activity - but there's no way to know at the moment. Our method may allow health professionals to gain a much clearer picture of patients' brain function."<br /><br />Concordia researchers are continuing to evaluate and refine this method of seizure detection. More patient data from several different centres is being reviewed, and further publications on the subject are planned. So far, according to Agarwal, results are promising.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/ece-member-pioneers-seizure-detection-method.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
ECE member pioneers seizure detection method
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/03/ece-member-...ethod.php </p>
