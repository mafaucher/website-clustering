...
<head>
	...
	<title>
ENCS awarded first place in national competition
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2009%2F10%2Fencs-awarded-first-place-in-national-competition.php','%0AENCS%20awarded%20first%20place%20in%20national%20competition%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/10/encs-awarded-first-place-in-national-competition.php#maincontent" accesskey="s">Skip to Content</a></li>
...
ENCS awarded first place in national competition
			...
			<div class="entry-meta" title="2009-10-04T17:05:22-05:00">Sunday Oct  4, 2009</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
It was recently announced that a capstone project of Concordia's Faculty of Engineering and Computer Science won the first place prize of $10,000 at this year's national <b>IEEE TELUS Innovation Awards</b>.<br /><br />This annual event pits the top capstone projects from universities across Canada against each other in a fierce competition centred on the timely subject of Information Computing and Telecommunication Technologies. &nbsp;<br /><br />This year, five capstone projects (the practical and for-credit work of students in the last year of an engineering or technology program) were selected for the final competition. The excited team of ENCS students, led by <b>Professor M. Reza Soleymani </b>of the Department of Electrical and Computer Engineering, was invited to the final competition held in Mississauga. There, they presented their project entitled "Multi-Touch Multi-User Interactive Surface Using Computer Vision" to the assembled judges. This year,<b> Ibrahim Gedeon</b>, VP of TELUS, sat on the panel and expressed interest in providing further funding for this groundbreaking project.<br /><br /><b>About IEEE &amp; Telus</b><br />Originally an acronym for the <a class="zem_slink" href="http://www.ieee.org/" title="Institute of Electrical and Electronics Engineers" rel="homepage">Institute of Electrical and Electronics Engineers</a>, Inc, IEEE's scope of interest has expanded into so many related fields, that it is simply referred to by the letters I-E-E-E (pronounced Eye-triple-E). It is known worldwide as a leading professional association for the advancement of technology. TELUS is a leading national telecommunications company in Canada, and provides a wide range of communications products and services across the country.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/10/encs-awarded-first-place-in-national-competition.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
ENCS awarded first place in national competition
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2009/10/encs-awarde...ition.php </p>
