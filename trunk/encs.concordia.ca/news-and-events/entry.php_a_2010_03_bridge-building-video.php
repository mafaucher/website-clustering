...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F03%2Fbridge-building-video.php','%0ABridge%20Building%20Video%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/03/bridge-building-video.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Bridge Building Video
			...
			<div class="entry-meta" title="2010-03-18T11:32:33-05:00">Thursday Mar 18, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
The 26th annual <a href="http://www.troitsky.ca/">Troitsky Bridge Building Competition</a> was captured on film by the talented team of videographers from Concordia's University Communications Services. Watch the excerpt below from the day's event to relive the intensity that is Troitsky! <br /><br /><script src="http://www.concordia.ca/about/whoweare/videogallery/player/liveStream/archive/Scripts/AC_RunActiveContent.js" type="text/javascript"></script>
<script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,79,0','width','320','height','240','id','FLVPlayer','src','http://www.concordia.ca/about/whoweare/videogallery/player/liveStream/archive/FLVPlayer_Streaming','flashvars','&MM_ComponentVersion=1&serverName=pegasus.concordia.ca&skinName=http://www.concordia.ca/about/whoweare/videogallery/player/liveStream/archive/Clear_Skin_3&appName=Archive/bridge_building2010&streamName=bridge_building2010&isLive=false&bufferTime=0&autoPlay=true&autoRewind=false','quality','high','scale','noscale','name','FLVPlayer','salign','lt','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','http://www.concordia.ca/about/whoweare/videogallery/player/liveStream/archive/FLVPlayer_Streaming' ); //end AC code
</script><br />Please note: the video stays on the same shot for a little while: just slide the bar along a little and you'll see the action start.
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/03/bridge-building-video.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Bridge Building Video
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/03/bridge-buil...video.php </p>
