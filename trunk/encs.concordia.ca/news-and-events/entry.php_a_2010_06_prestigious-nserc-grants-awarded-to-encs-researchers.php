...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F06%2Fprestigious-nserc-grants-awarded-to-encs-researchers.php','%0APrestigious%20NSERC%20grants%20awarded%20to%20ENCS%20researchers%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/06/prestigious-nserc-grants-awarded-to-encs-researchers.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Prestigious NSERC grants awarded to ENCS researchers
			...
			<div class="entry-meta" title="2010-06-22T16:01:19-05:00">Tuesday Jun 22, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
On Tuesday, June 22, 2010, the Natural Sciences and Engineering Research Council of Canada announced the recipients of the 2010 <a href="http://www.nserc-crsng.gc.ca/Professors-Professeurs/Grants-Subs/DGAS-SGSA_eng.asp">Discovery Accelerator Supplements</a> program (DAS). This prestigious program provides substantial and timely additional resources to accelerate progress and maximize the impact of outstanding research programs.

<br /><br />This year, Concordia enjoyed unprecedented success with the program, securing six awards--all within the Faculty of Engineering and Computer Science.  Congratulations to all our awarded researchers:

<br /><br /><ul><li>Sofiene Tahar, Electrical and Computer Engineering</li><li>Ali Dolatabadi, Mechanical and Industrial Engineering</li><li>Catherine Mulligan, Building, Civil, and Environmental Engineering</li><li>Ibrahim Hassan, Mechanical and Industrial Engineering</li><li>Osama Moselhi, Building, Civil, and Environmental Engineering</li><li>Amr Youssef, Concordia Institute for Information System Engineering
<br /></li></ul>Each award represents $120,000 over three years, and is given in order to help propel the research activities towards increased productivity. Recipients of the highest quality are selected during the annual Discovery Grants Competition by the NSERC evaluation committees. 

<br /><br />The DAS are a new component of the Discovery Grants Program and aim to provide substantial and timely additional resources to accelerate progress and maximize the impact of outstanding research programs. Evaluation Group members nominated candidates for DAS during Discovery Grant competition discussions, and the Executive Committee of each Evaluation Group selected the final winners from their group of nominees.
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/06/prestigious-nserc-grants-awarded-to-encs-researchers.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Prestigious NSERC grants awarded to ENCS researchers
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/06/prestigious...chers.php </p>
