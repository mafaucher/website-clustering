...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F02%2Fencs-profs-not-just-science-geeks-1.php','%0AENCS%20Prof%20publishes%20on%20Homer%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/02/encs-profs-not-just-science-geeks-1.php#maincontent" accesskey="s">Skip to Content</a></li>
...
ENCS Prof publishes on Homer
			...
			<div class="entry-meta" title="2010-02-15T16:26:46-05:00">Monday Feb 15, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="cda_displayimage.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/cda_displayimage.jpg" class="mt-image-left" style="margin: 0pt 20px 20px 0pt; float: left;" width="153" height="232" />ENCS Professor<b> Georgios Vatistas</b>
has proven that engineers can look beyond pure science and, like true
"Renaissance men," interact with the arts! There is ample evidence for
this in the recent publication entitled "Science and Technology in
Homeric Epics" (edited by S. A. Papipetis and published by Springer in
their History of Mechanism and Machine Science series).<br />
<br />
The book is based on presented at the international symposium "Science
and Technology in Homeric Epics," given in Ancient Olypia in August
2006. It features an essay by Vatistas entitled "<b style=""><span style=""></span><o:p></o:p></b>

Vortices in Homer's Odyssey - A Scientific Approach," as well as a paper by fellow Concordian <b>Annette Teffeteller</b>
(associate professor in the Department of Classics, Modern Languages
and Linguistics) entitled "Linguistic Science and Script Technology:
The Homeric Evidence."<br />
<br />
The book aims to challenge the notion that the seemingly scientific
knowledge and admirable technological achievements presented in the
Homeric epics should be attributed to poetic inspiration rather than to
a solid scientific mind.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/02/encs-profs-not-just-science-geeks-1.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
ENCS Prof publishes on Homer
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/02/encs-profs-...eks-1.php </p>
