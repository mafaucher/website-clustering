...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F10%2Fvatistas-wins-major-national-award.php','%0AVatistas%20wins%20major%20national%20award%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/10/vatistas-wins-major-national-award.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Vatistas wins major national award
			...
			<div class="entry-meta" title="2010-10-08T12:24:15-05:00">Friday Oct  8, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<div align="left"><img alt="vatistas.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/vatistas.jpg" class="mt-image-left" style="float: left; margin: 0pt 20px 20px 0pt;" height="220" width="220" />The Faculty of Engineering and Computer Science is pleased to announce that <a href="http://users.encs.concordia.ca/%7Evatistas/">George Vatistas</a>, Professor in the <a href="http://www.me.concordia.ca/">Department of Mechanical and Industrial Engineering</a> has been awarded a prestigious "Idea to Innovation" grant from the <a href="http://www.nserc-crsng.gc.ca/index_eng.asp">Natural Sciences and Engineering Research Council</a> (NSERC).<br /></div><br />The objective of the <a href="http://www.nserc-crsng.gc.ca/Professors-Professeurs/RPP-PP/I2I-INNOV_eng.asp">Idea to Innovation</a> (I2I) program is to "accelerate the pre-competitive development of promising technology and promote its transfer to Canadian companies," according to the governmental funding agency. In essence, the program was established in order to assist professors in the development of marketable products based on scientific research.<br /><br />Because few research programs mature into marketability, these awards are a rare occurrence. Indeed, even though the I2I program has been in existence for five years, this is only the third time a researcher at Concordia has ever been chosen.<br /><br />Vatistas says he is honoured to be part of such a select crowd, noting that the award "shows that the work going on right here in the Faculty of Engineering and Computer Science has great value, both academically and in industry." <br /><br />The project that the I2I grant, worth $115,452, will fund is a brand new type of compact heat exchanger that Vatistas and his post doctoral fellow Mohamed Fayed designed based on pioneering research into swirling flows spanning over two decades. The heat exchanger will be simpler in design and easier to manufacture than models currently on the market. It will also be superior in effectiveness and more environmentally friendly device. The heat exchanger has potential applications for power plants, petrochemical plants, natural gas processing, oil refineries, air conditioning, refrigeration, and even food processors. <br /><br />Vatistas and Fayed filed a provisional patent for the product with the US Patent Office in June 2009 and plans to submit his final project report to NSERC in late 2011.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/10/vatistas-wins-major-national-award.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Vatistas wins major national award
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/10/vatistas-wi...award.php </p>
