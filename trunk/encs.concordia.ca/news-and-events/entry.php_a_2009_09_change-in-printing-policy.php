...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2009%2F09%2Fchange-in-printing-policy.php','%0AChange%20in%20Printing%20Policy%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/09/change-in-printing-policy.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Change in Printing Policy
			...
			<div class="entry-meta" title="2009-09-01T12:24:38-05:00">Tuesday Sep  1, 2009</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
Dear Engineering and Computer Science Students,<br /><br />As you're probably aware, the global financial crisis has had an impact on many different sectors: universities haven't been immune to this. ENCS has long been proud of that fact that it was the only faculty at Concordia that let its students print their documents for free. Unfortunately, even "free" things cost money: things like toner cartridges, paper, and staff time have cost us a lot over the years. So, it is with a great reluctance, that we are ending our program of free printing for ENCS students.<br /><br />But don't worry! Printing your documents still won't break the bank. From September 1 on, you will be able to print at a very reasonable cost of 6 cents per black-and-white page. You can pay for your printing by buying a special card at Printing Services, located in the library building.&nbsp; Your new card will work with ENCS printers in the Hall building, as well as Library printers in the LB building.<br /><br />To help you with this transition, we're giving all ENCS student their first 200 pages of printing for free. After you've used up your quota of 200 pages, you can make the switch over to using the printing cards to pay for any extra printing. The quota will expire at the end of the 2009/10 academic year.<br /><br />The money that ENCS saves on printing will help us to keep providing students with popular services like our computer labs and the Microsoft Academic Alliance membership that gives students free downloads of many popular Microsoft products.<br /><br />I do apologize for this inconvenience and hope that it won't have too much of a negative effect on the start of the fall semester.<br /><br />With best wishes,<br /><br />Dr. C. W. Truman<br />Associate Dean, Academic Affairs<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/09/change-in-printing-policy.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Change in Printing Policy
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2009/09/change-in-p...olicy.php </p>
