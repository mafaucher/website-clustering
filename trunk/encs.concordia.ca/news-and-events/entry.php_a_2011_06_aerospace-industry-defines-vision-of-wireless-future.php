...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F06%2Faerospace-industry-defines-vision-of-wireless-future.php','%0AAerospace%20Industry%20Defines%20Vision%20of%20Wireless%20Future%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/06/aerospace-industry-defines-vision-of-wireless-future.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Aerospace Industry Defines Vision of Wireless Future
			...
			<div class="entry-meta" title="2011-06-24T09:13:57-05:00">Friday Jun 24, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
Concordia University recently played host to the 2011 CANEUS / IEEE 2011 Fly-by-Wireless workshop, which saw leaders from the aerospace industry and researchers from academia come together to discuss advances in the use of wireless technology in aircraft. The three-day meeting was held from June 14-17 and resulted in defining the requirements of the aerospace community and investigating how wireless technologies of today and tomorrow can meet these needs. Workshop delegates from 11 countries spanning the Americas, Europe, Asia,&nbsp; and Africa, and representing technology providers, technology end users, academia, and government agencies met to present their visions of wireless technologies and worked throughout the 4 days of the workshop to bring these vision to life. <br /><br /><div align="center"><img alt="fbw.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/fbw.jpg" class="mt-image-center" style="text-align: center; display: block; margin: 0pt auto 20px;" width="440" height="330" /><i>Participants at the workshop</i><br /></div><br />The core premise of the FBW11 Workshop was that a multi-national, shared effort would be established to promote cooperation, trust and interdependence for the mutual benefit of all potential partners. Because complementary skill sets and resources from across the world are needed to rapidly and cost-effectively transform emerging wireless concepts into tomorrow's aerospace and aeronautics industries, meetings like FBW11 are invaluable. <br /><br />By reviewing the progress of previous projects, forming new project teams, and coming up with funding and execution plans, the participants of FBW11 were able to meet their goals of establishing milestones from which to gauge success of current and future projects. To this end, participants representing the end-user and stakeholders helped formulate 8 projects that will be led or driven by the leadership from companies and organizations including NASA, Rolls Royce, Pratt &amp; Whitney, Bombardier, Airbus, Meggitt, Goodrich, Boeing Space Exploration, DLR, Genetlab, and DRD Canda.&nbsp; <br /><br />For more on these projects and on the Fly By Wireless workshop, please visit the CANEUS website at <a href="http://www.caneus.org/">www.caneus.org</a>.<br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/06/aerospace-industry-defines-vision-of-wireless-future.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Aerospace Industry Defines Vision of Wireless Future
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/06/aerospace-i...uture.php </p>
