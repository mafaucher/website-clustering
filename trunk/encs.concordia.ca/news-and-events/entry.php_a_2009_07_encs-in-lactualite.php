...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2009%2F07%2Fencs-in-lactualite.php','%0AENCS%20in%20l%27Actualit%C3%A9%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/07/encs-in-lactualite.php#maincontent" accesskey="s">Skip to Content</a></li>
...
ENCS in l'Actualité
			...
			<div class="entry-meta" title="2009-07-03T15:28:47-05:00">Friday Jul  3, 2009</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
On July 2, the rooftop of the Pharmaprix building at the corner of Ste-Catherine and Guy was transformed into a photographer's studio. That's where Dr. Andreas Athienitis, professor in the Department of Building, Civil &amp; Environmental Engineering and Network Leader in the Solar Buildings Research Network posed for a photo to accompany the profile of him that is set to appear in the August issue of <a class="zem_slink" href="http://www.lactualite.com/" title="L'actualité" rel="homepage">l'Actualité</a> magazine.<br /><br /><a href="http://newsfeed.encs.concordia.ca/encs_test/assets_c/2010/01/athienitis-31.html" onclick="window.open('http://newsfeed.encs.concordia.ca/encs_test/assets_c/2010/01/athienitis-31.html','popup','width=520,height=390,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0'); return false"><img src="http://newsfeed.encs.concordia.ca/encs_test/assets_c/2010/01/athienitis-thumb-440x330-31.jpg" alt="Andreas Athienitis" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" width="440" height="330" /></a>Behind the lens was acclaimed photojournalist <a href="http://www.rogerlemoyne.com/">Roger Lemoyne</a>. His keen eye captured Dr. Athienitis next to an installation used to test solar panels like the ones used atop the brand new <a class="zem_slink" href="http://maps.google.com/maps?ll=45.497406,-73.577102&spn=1.0,1.0&q=45.497406,-73.577102%20%28John%20Molson%20School%20of%20Business%29&t=h" title="John Molson School of Business" rel="geolocation">John Molson School of Business</a> Building, which will officially open in September. The magazine article will focus on Dr. Athienitis's groundbreaking research into solar energy. Be sure to look for the issue on newsstands come August! <br /><div><br /></div><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/07/encs-in-lactualite.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
ENCS in l'Actualité
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2009/07/encs-in-lac...alite.php </p>
