...
<head>
	...
	<title>
Faculty engages with industry through federal grant program
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F03%2Ffaculty-engages-with-industry-through-federal-grant-program.php','%0AFaculty%20engages%20with%20industry%20through%20federal%20grant%20program%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/faculty-engages-with-industry-through-federal-grant-program.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Faculty engages with industry through federal grant program
			...
			<div class="entry-meta" title="2011-03-31T15:32:33-05:00">Thursday Mar 31, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="nserc.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/nserc.jpg" class="mt-image-left" style="float: left; margin: 0pt 20px 20px 0pt;" width="200" height="280" />Concordia's Faculty of Engineering and Computer Science prides itself on close ties to industry and a strong history of federal granting success. The latest fiscal year has seen the Faculty make great strides in both, as it received an unprecedented number of <a href="http://www.nserc-crsng.gc.ca/Professors-Professeurs/RPP-PP/Engage-Engagement_eng.asp">Engage Grants</a> from the Natural Sciences and Engineering Research Council of Canada (NSERC). <br /><br />With a total of 16 applications submitted to date to this federally-funded program, faculty members were ambitious in the goals. The results are now coming in and it looks like that ambition is being amply repaid, with success across the board! So far, the following individuals have been confirmed as recipients: Samar Abdi, Paul Fazio, Scott Gleason, Suong Van Hoa, Samuel Li, Mamoun Medraj, Catherine Mulligan, Olga Ormandjieva,&nbsp; Pragasen Pillay, Luis Rodrigues, Sofiène Tahar, Sheldon Williamson, Yuhong Yan, and Yong Zeng. Their projects cover diverse aspects of engineering and computer science and are sure to foster exciting developments.<br /><br />Launched by NSERC in December 2009, the Engage Grants give Canadian companies the chance to foster the development of new research partnerships with researchers at Canadian universities. The grants provide up to $25,000 over 6-months and support short-term research and development projects aimed at addressing a company-specific problem in the natural sciences or engineering fields. Recipients are selected based on the creation of a new collaborative relationship; research competence as collaborators; industrial relevance; contribution to technology transfer; and benefit to Canada.<br /><br />Congratulations to all our recipients!<br /><br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/faculty-engages-with-industry-through-federal-grant-program.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Faculty engages with industry through federal grant program
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/03/faculty-eng...ogram.php </p>
