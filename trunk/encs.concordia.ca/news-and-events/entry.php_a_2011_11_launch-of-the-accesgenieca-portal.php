...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F11%2Flaunch-of-the-accesgenieca-portal.php','%0ALaunch%20of%20the%20accesgenie.ca%20portal%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/11/launch-of-the-accesgenieca-portal.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Launch of the accesgenie.ca portal
			...
			<div class="entry-meta" title="2011-11-28T11:24:02-05:00">Monday Nov 28, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="accesgenie_noir.png" src="http://newsfeed.encs.concordia.ca/encs_test/accesgenie_noir.png" class="mt-image-right" style="float: right; margin: 0 0 20px 20px;" height="100" width="320" />The continuing education centres of the engineering faculties at the Université de Sherbrooke and Polytechnique Montréal, and the School of Extended Learning at Concordia University (in collaboration with Concordia University's Faculty of Engineering and Computer Science), have launched the accesgenie.ca portal, a new website that will propose university level professional development services. The initiative gives concrete expression to their partnership to provide continuing education services for their graduates and engineers. The event took place on Monday, November 28, 2011, in the Espace culturel of the library of Polytechnique Montréal located on the seventh floor of the Lassonde buildings.<br /><br />Representatives of the three educational institutions, Pierre G. Lafleur, Director, Academic and International Affairs, Polytechnique Montréal; Dominique Lefebvre, Assistant Dean of Professional Development, Université de Sherbrooke; Noel Burke, Dean, School of Extended Learning, Concordia University; and Robin Drew, Dean, Faculty of Engineering and Computer Science, Concordia University, spoke at the event.<br /><br /><div align="center"><img alt="accessweb.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/accessweb.jpg" class="mt-image-center" style="text-align: center; display: block; margin: 0 auto 20px;" height="230" width="440" /><i><font style="font-size: 0.8em;">Left to right: Pierre G. Lafleur, Chief Academic and International Officer, Polytechnique Montréal; Noel Burke, Dean, School of Extended Learning, Concordia University; Robin Drew, Dean, Faculty of Engineering and Computer Science, Concordia University and Dominique Lefebvre, Assistant Dean of Continuing Education, Université de Sherbrooke.</font></i><br /></div><br />The institutions consolidated their resources and expertise in order to gradually offer services that will enable their clienteles to enrich their skills and qualifications to plan and develop their careers. The accesgenie.ca portal marks the first stage in their collaboration. The site proposes quick access through a single outlet to a list of courses in an array of sectors of activity specifically related to engineering. Other services relevant to engineers' needs in their professional activities will be offered in the coming months.<br /><br />The new partnership has been established to satisfy needs stemming from the new regulation on the professional development of engineers, which compels members of the Ordre des ingénieurs du Québec to accumulate at least 30 hours of professional development during a two-year reference period.<br /><br />Engineers and technologists will thus be able to quickly access the foremost expertise of three major faculties of engineering in Québec and Canada through <a href="http://accesgenie.ca/">accesgenie.ca.</a> <div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/11/launch-of-the-accesgenieca-portal.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Launch of the accesgenie.ca portal
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/11/launch-of-t...ortal.php </p>
