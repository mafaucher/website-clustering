...
<head>
	...
	<title>Undergraduate program requirements - Engineering &amp; Computer Science - Concordia University - Montreal, Quebec, Canada</title>
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fcurrent-students%2Fundergraduate-program-requirements%2Findex.php','Undergraduate%20program%20requirements', '/');
					});
	}
...
<body id="body_li_undergraduate-program-requirements_2" class="li_mainmenu_current-students_1 li_submenu_undergraduate-program-requirements_2" >
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/current-students/undergraduate-program-requirements/index.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<li id="li_submenu_undergraduate-program-requirements_2" class="active">
<strong>Undergraduate<br />program requirements </strong></li>
<li id="li_submenu_graduate-program-requirements_2" >
<a class="li_submenu_graduate-program-requirements_2_a" href="http://www.encs.concordia.ca/current-students/graduate-program-requirements/">
Graduate program<br />requirements </a>
</li>
<li id="li_submenu_registration_2" >
<a class="li_submenu_registration_2_a" href="http://www.encs.concordia.ca/current-students/registration/">
Registration </a>
</li>
<li id="li_submenu_forms-and-procedures_2" >
<a class="li_submenu_forms-and-procedures_2_a" href="http://www.encs.concordia.ca/current-students/forms-and-procedures/">
Forms &amp; Procedures </a>
</li>
...
Industrial experience </a>
	...
	<div id="maincontent"  class="topgutter"  >
		...
		<div id="lh_menu">
<ul class="level_3">
<li id="li_course-sequences_3"> <a class="li_course-sequences_3_a" href="course-sequences/index.html">
<span>Course sequences</span> </a>
 </li>
<li id="li_capstone-projects_3"> <a class="li_capstone-projects_3_a" href="capstone-projects/index.html">
<span>Capstone projects</span> </a>
</li>
<li id="li_writing-test_3"> <a class="li_writing-test_3_a" href="http://www.encs.concordia.ca/current-students/undergraduate-program-requirements/writing-test/">
<span>Writing test</span> </a>
</li>
<li id="li_grade-point-average_3"> <a class="li_grade-point-average_3_a" href="http://www.encs.concordia.ca/current-students/undergraduate-program-requirements/grade-point-average/">
<span>Grade Point Average</span> </a>
</li>
<li id="li_graduation_3"> <a class="li_graduation_3_a" href="http://www.encs.concordia.ca/current-students/undergraduate-program-requirements/graduation/">
<span>Graduation</span> </a>
	...
	<h1>Undergraduate program requirements</h1>
...
<!-- InstanceBeginEditable name="Sidebar" -->
	 <div class="sidebar_box_1"><h2>Undergraduate Program Advising</h2>

<h3>Newly Admitted Students</h3>

<p>Undergraduate students that have been newly admitted to the Faculty of Engineering and Computer Science must  carefully read the <a href="http://www.encs.concordia.ca/documents/Ugrad-Advising-Guide.pdf">Advising Guide</a> before they proceed to registration.</p>

<h3>Returning Students</h3>

<p>For advising information, please consult the <a href="http://registrar.concordia.ca/webguide/ECSadv.html">ENCS registration guide</a>.</p>

<p>Should you need to book an appointment with an Academic Advisor at SAS , please call Student Academic Services at +1-514-848-2424, ext. 3055 or 3057.</p></div> <div class="sidebar_box_1">
...
<!-- InstanceBeginEditable name="MainContent" -->
	  <h2>Course sequences</h2>
	  <p>Students accepted to ENCS programs, who have completed all required prerequisites, follow a sequence that would lead to graduation after four years (8 terms) of study. The <a href="course-sequences/index.html">courses sequence pages</a> provide a summary of the courses that students in each of the Engineering programs have to follow in their first year of study.</p>
	  <h2>Capstone projects</h2>
	  <p>In their final year, students will participate in leading-edge research while working on special projects that enable them to carry out a team design project from scratch, experience project management, and practice their technical writing and presentation skills. Find out more about <a href="capstone-projects/index.html">capstone project requirements</a>.</p>
	  <h2>Writing test</h2>
	  <p>All students in the Faculty of Engineering and Computer Science must satisfy the Faculty writing skills requirement, using one of two options of the <a href="http://www.encs.concordia.ca/current-students/undergraduate-program-requirements/writing-test/">ENCS Writing Test</a>.</p>
	  <h2>Grade Point Average</h2>
	  <p> A weighted <a href="http://www.encs.concordia.ca/current-students/undergraduate-program-requirements/grade-point-average/">grade point average</a> of 2.00 is required for acceptable standing in the Faculty of Engineering and Computer Science.</p>
	  <h2>Graduation</h2>
<p>In order to graduate, students must satisfy all program requirements and be in acceptable standing. Find out more about <a href="http://www.encs.concordia.ca/current-students/undergraduate-program-requirements/graduation/">curriculum evaluations and graduation checklists</a>.</p>
    <!-- InstanceEndEditable --><br class="hide" />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/current-students/undergraduate-program-requirements/index.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Undergraduate program requirements - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/current-students/undergraduate-program-require...index.php </p>
