...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fcontactus.php','Contact%20us', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/contactus.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<p>Please consult the <a href="http://www.encs.concordia.ca/resources/faculty-and-staff-directory/index.php">Faculty and Staff directory</a> for information about the Faculty, Student Academic Services, Academic Facilities, Academic Programs, Research and Graduate Studies and Administrative Services.</p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/contactus.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Contact us - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/contactus.php ...</p>
