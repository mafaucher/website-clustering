...
<head>
	...
	<title>Research Support - Engineering &amp; Computer Science - Concordia University - Montreal, Quebec, Canada</title>
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fpolicies-and-procedures%2Fresearch-support%2Findex.php','Research%20Support', '/');
					});
	}
...
<body id="body_li_research-support_2" class="li_mainmenu_policies-and-procedures_1 li_submenu_research-support_2" >
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/policies-and-procedures/research-support/index.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<a class="li_submenu_budget-and-finance_2_a" href="../budget-and-finance/">
Budget and finance </a>
</li>
<li id="li_submenu_research-support_2" class="active">
<strong>Research Support </strong></li>
...
Teaching </a>
	...
	<div id="maincontent"  class="topgutter"  >
		...
		<div id="lh_menu">
<ul class="level_3">
<li id="li_cara-funds_3"> <a class="li_cara-funds_3_a" href="cara-funds/index.html">
<span>CARA Funds</span> </a>
</li>
<li id="li_gssp_3"> <a class="li_gssp_3_a" href="gssp/index.html">
<span>Grad Student<br />Support Funds</span> </a>
</li>
<li id="li_start-up-funds_3"> <a class="li_start-up-funds_3_a" href="start-up-funds/index.html">
<span>Start&ndash;up Funds</span> </a>
</li>
<li id="li_external-funding_3"> <a class="li_external-funding_3_a" href="http://www.encs.concordia.ca/policies-and-procedures/research-support/external-funding/">
<span>External Funding</span> </a>
</li>
<li id="li_workshops_3"> <a class="li_workshops_3_a" href="http://www.encs.concordia.ca/policies-and-procedures/research-support/workshops/">
...
<div class="sidebar_box_1">
  <h2>For more information on research funding</h2>
  <p><strong>Visit:</strong> <a href="../../administration-and-governance/administrative-units/research-office/index.html">Research Office</a></p>

	<strong>Contact:</strong><br />
  <ul>
		<li>
			<p>
			Georgia Michalakopoulos, <br />
			Research Officer <br />
			Faculty of Engineering and Computer Science, EV002.139 <br />
			Tel. (514) 848-2424 ext. 4036 <br />
			Fax (514) 848-4509 <br />
			Email: <a href="mailto:researchofficer@encs.concordia.ca">researchofficer@encs.concordia.ca</a>
			</p>
		</li>
    	<li>
			<p>
			Lori Feng, <br />
			Assistant to the Associate Dean of Research and Graduate Studies<br />
			Faculty of Engineering and Computer Science, EV002.158 <br />
			Tel. (514) 848-2424 ext. 5684<br />
			Fax (514) 848-4509 <br />
			Email: <a href="mailto:lori@encs.concordia.ca">lori@encs.concordia.ca</a>		  </p>
			<hr>
    	</li>
    	<li>Minodora Iordan, <br />
   	      Research Facilitator <br />
   	      EV002.156 <br />
   	      Tel. (514) 848-2424 ext. 3263 Fax (514) 848-4509 <br />
        Email: <a href="mailto:iordan@encs.concordia.ca">iordan@encs.concordia.ca</a> </li>
    </ul>
</div>
...
<!-- InstanceBeginEditable name="MainContent" -->
  ...
  <p>The Research Office assists the Office of the Dean with the management of internal funding programs, and the review of external research grant applications and contracts for Faculty approval. Faculty members can find information on the following funding programs in this area of the website:</p>
  
  <h2>CARA funds</h2>
  <p>Faculty members can apply for <a href="cara-funds/index.html">CARA funds</a> in order to provide financial support to partially defray the salary of a visiting scientist, research associate, postdoctoral fellow; or   graduate thesis student.      </p>
  
  <h2>Graduate Student Support Program</h2>
  <p>Check <a href="gssp/index.html">this page</a> for the policy on the Faculty of Engineering and Computer Science Graduate Student Support Program (GSSP)</p>
  
  <h2>Start-up funds</h2>
  <p><a href="start-up-funds/index.html">Start-up funds</a> are provided by the Dean of the Faculty of Engineering and Computer Science to new ENCS faculty members.  The funds must normally be spent within 2 fiscal years.</p>
  <h2>External Funding</h2>
  <p>There are several opportunities for Engineering and Computer Science Faculty members to gain <a href="http://www.encs.concordia.ca/policies-and-procedures/research-support/external-funding/">funding from external sources</a>. </p>
  <h2>Workshops</h2>
  <p><a href="http://www.encs.concordia.ca/policies-and-procedures/research-support/workshops/">Research workshops</a> are conducted several times a year by the Concordia Office of Research or the Office of the Associate Dean, Research and Graduate Studies in ENCS.</p>
<!-- InstanceEndEditable --><br class="hide" />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/policies-and-procedures/research-support/index.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Research Support - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/policies-and-procedures/research-support/index....php </p>
