...
<head>
	...
	<title>Centres - Engineering &amp; Computer Science - Concordia University - Montreal, Quebec, Canada</title>
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fresearch%2Fcentres%2Findex.php','Centres', '/');
					});
	}
...
<body id="body_li_centres_2" class="li_mainmenu_research_1 li_submenu_centres_2" >
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/research/centres/index.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<li id="li_mainmenu_research_1" class="active">
<a class="li_mainmenu_research_1_a" href="../">
Research </a>
</li>
...
<div class="submenu">
<ul id="ul_research"> <li id="li_submenu_faculty-expertise-guide_2" >
<a class="li_submenu_faculty-expertise-guide_2_a" href="../faculty-expertise-guide/">
Faculty expertise<br />guide </a>
</li>
<li id="li_submenu_chairs-and-awards_2" >
<a class="li_submenu_chairs-and-awards_2_a" href="../chairs-and-awards/index.html">
Chairs &amp; awards </a>
</li>
<li id="li_submenu_centres_2" class="active">
<strong>Centres </strong></li></ul>
</div>
	<div id="maincontent"  class="topgutter"  >
		<div id="lh_menu_area">
		<div id="lh_menu">
<ul class="level_3">
<li id="li_consim_3"> <a class="li_consim_3_a" href="consim/index.html">
<span>ConSiM</span> </a>
 </li>
</ul>
</div>
		...
		<div class="insidecontent ">
			...
			<p class="breadcrumb"><a href="../../index.html">ENCS Home</a> &gt; <a href="../index.php">Research</a> &gt; </p>
...
<!-- InstanceBeginEditable name="Sidebar" -->
  ...
  <p>The Faculty of Engineering and Computer Science's <a href="../../administration-and-governance/administrative-units/research-office/index.html">Research Office</a> assists the Office of the Dean with the management  of internal funding programs, and the review of external research grant  applications and contracts for Faculty approval.</p>
  </div>
...
<!-- InstanceBeginEditable name="MainContent" -->
  <p>The following centres are affiliated with Concordia's Faculty of Engineering and Computer Science.</p>
  
  <h2><a href="http://www.cenparmi.concordia.ca/">Concordia Centre for Pattern Recognition and Machine Intelligence</a></h2>
  <p>
    Pattern recognition and machine intelligence (PARMI) has been a very active field in the past 20 years, particularly in the application area. PARMI techniques have been used to recognize characters, time-varying signals, voice, satellite pictures, objects, fingerprints, and weather patterns, in many scientific, business, and military applications. </p>
    
  
  <h2><a href="http://www.bcee.concordia.ca/index.php/Centre_for_Building_Studies">Centre for Building Studies</a></h2>
<p>
  The Centre for Building Studies (CBS) is a research centre whose goal is to conduct research that contributes to the building construction industry and that leads to buildings that are more energy efficient, comfortable, healthy, safe, and responsive to their inhabitants.  </p>
  
  <h2><a href="http://concave.concordia.ca/">Concordia Centre for Advanced Vehicle Engineering</a></h2>
<p>
  CONCAVE was founded in 1985 to focus research and development efforts  in the area of Transport Technology. The establishment of the centre  was made possible through several awards from federal and provincial  organizations including a special grant under the Programme d&rsquo;actions  structurantes by the Minist&egrave;re de l&rsquo;enseignement sup&eacute;rieur et de la  science, Gouvernement du Qu&eacute;bec (FCAR). </p>
  
  <h2><a href="http://concom.encs.concordia.ca/">Concordia Centre for Composites</a></h2>
<p>
  CONCOM has carried out research projects in composites since its  establishment in 1979. The interest of researchers at the CONCOM center  covers many areas: polymer composites, nanocomposites, polymer/metalic  alloy, design of composite structures, testing of materials structures  and properties, and development of new materials and manufacturing  techniques. </p>
  
  <h2><a href="http://users.encs.concordia.ca/~ccil/">Concordia Computational Intelligence Laboratory</a></h2>
<p>
  The Concordia Computational Intelligence Laboratory (CCIL) grew out of the work and research of members of Concordia University's Computer Engineering and Computer Science faculty as well as a number of graduate students and collaborators in a range of other academic disciplines.</p>
  
  <h2><a href="http://www.concordia.ca/documents/academics/research/units/CENSIPCOM.pdf">Centre for Signal Processing and Communications</a></h2>
<p>
  Established in 1988, CENSIPCOM focuses on research and development projects related to various branches and applications of signal processing and communications. Its mission is to provide research and development leadership in the areas of Signal Processing and Communications.</p>
  
  <h2><a href="http://www.mie.concordia.ca/research/researchcentres/">Centre for Industrial Control</a></h2>
<p>
  CIC was established in 1983 by the Board of Governors of Concordia University. Its mandate is to pursue excellence in industrial control and automation through education, research and active interaction with the industry.  </p>
<h2><a href="http://hvg.ece.concordia.ca/">Hardware Verification Group</a></h2>
<p>This Group is one of the several research labs in the department of Electrical and Computer Engineering in Concordia University. Its mission is the development of methodologies, algorithms and tools for the formal and semi-formal verification of hardware and embedded systems.</p>
<h2><a href="http://www.solarbuildings.ca/en/network">Solar Buildings Research Network</a></h2>
<p>
  The vision of the Solar Buildings Research Network (SBRN) is the  development of the solar-optimized building as an integrated advanced  technological system that approaches net-zero energy consumption while  being cost effective and comfortable. </p>
  
  <h2><a href="http://users.encs.concordia.ca/~wasc/">Wireless and Satellite Communications Lab</a></h2>
<p>
  The mission of the Wireless and Satellite Communications Lab is to conduct scientifically sound and industrially relevant research in the areas of wireless and satellite communications with the aim of developing techniques to facilitate tetherless multimedia communications and to train of Highly Qualified Personnel (HQP) for the Wireless and Satellite Communications Industry. </p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/research/centres/index.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Centres - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/research/centres/index.php ...</p>
