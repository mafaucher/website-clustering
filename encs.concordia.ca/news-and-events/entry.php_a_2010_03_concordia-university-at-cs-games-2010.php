...
<head>
	...
	<title>
 Concordia University at CS Games 2010
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F03%2Fconcordia-university-at-cs-games-2010.php','%0A%20Concordia%20University%20at%20CS%20Games%202010%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/03/concordia-university-at-cs-games-2010.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<!-- InstanceBeginEditable name="maincontent" --><!-- FCKEDITOR_maincontent --><!-- /FCKEDITOR_maincontent -->
 ...
 Concordia University at CS Games 2010
			...
			<div class="entry-meta" title="2010-03-10T16:23:26-05:00">Wednesday Mar 10, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
The province of Quebec has played proud host to the Computer Science Games yearly since 2003. The event attracts students from across the continent, who come to compete against dozens of dedicated teams. The competition consists of many different events focusing on the topic of Computer Science covering subjects such as theory, algorithms, artificial intelligence, software engineering and more. <br /><br /><div align="center"><img alt="CSgames2.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/CSgames2.jpg" class="mt-image-center" style="text-align: center; display: block; margin: 0pt auto 20px;" height="265" width="440" /><i>The Concordia delegation at the CS Games, held March 5-7 </i><br /></div><br />Concordia's Faculty of Engineering and Computer Science has been a participant in the games since their inception and returns to the competition year after year. This year, we sent two teams to the Games, which were held over the March 5 weekend to coincide with National Engineering Week. The participants came back proud, having never been more successful. Combined, both teams brought home 5 awards, including one team placing 3rd overall out of 27 teams. Concordia also won 1st and 3rd in relay programming, as well as 2nd in debugging. The teams were especially proud of the fact that they came in 3rd overall for participation. <br /><br />There were several other unofficial awards and honourable mentions that the ENCS teams received, such as recognition for "best costumes". The teams this year consisted of students from 1st year all the way to Concordia alumni from Computer Science and Software Engineering; everyone did their best at the games and represented Concordia with pride.<br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/03/concordia-university-at-cs-games-2010.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
 ...
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/03/concordia-u...-2010.php </p>
