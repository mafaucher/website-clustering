...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Ffaculty-magazine%2Farticle%2F%3Fa%3D2011%2F11%2Fgraduate-student-spotlight-2.php','%0AGraduate%20Student%20Spotlight%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2011/11/graduate-student-spotlight-2.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Get Connected </a>
	...
	<div id="maincontent"  class="topgutter"  >
		<div id="lh_menu_area">
		<div id="lh_menu">
<ul class="level_3"><li id="li_Fall2011_4"><a href="../issue.php_q_Fall_y_2011"><strong><span>Fall 2011</span></strong></a></li><li id="li_Summer2011_4"><a href="../issue.php_q_Summer_y_2011"><span>Summer 2011</span></a></li><li id="li_Winter2011_4"><a href="../issue.php_q_Winter_y_2011"><span>Winter 2011</span></a></li><li id="li_Fall2010_4"><a href="../issue.php_q_Fall_y_2010"><span>Fall 2010</span></a></li><li id="li_Spring2010_4"><a href="../issue.php_q_Spring_y_2010"><span>Spring 2010</span></a></li><li id="li_Winter2010_4"><a href="../issue.php_q_Winter_y_2010"><span>Winter 2010</span></a></li></ul></div>
	</div>
		<div class="insidecontent ">

			<p class="breadcrumb"><a href="../../../index.html">ENCS Home</a> &gt; <a href="../index.php">News &amp; events</a> &gt; <a href="index.php">Faculty Magazine</a> &gt; <a href="../issue.php_q_Fall_y_2011">Fall 2011</a> &gt;</p>
...
<img alt="Michelle_Boyce.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Michelle_Boyce.jpg" class="mt-image-right" style="float: right; margin: 0 0 20px 20px;" height="293" width="220" /><b>What's your background? </b><br />As a kid, I was fascinated by space and spent a lot of time thinking about the nature of reality. I went to a technical/vocational high school in Winnipeg, where I specialized in analogue electronics. I kept going deeper and deeper into the subject, asking lots of questions of my teachers. <br /><br />Eventually, I asked myself: "What exactly is an electron?" That's how I ended up in physics -- an interest that eventually led me to pursue a PhD in high-energy particle physics at Carleton University. Since earning my doctorate, my work has taken me from UBC's cyclotron accelerator to the AMANDA astroparticle physics experiment in Antarctica -- an experience I will never forget!<br /><br /><b>How did you first become interested in studying aerospace?</b><br />After working in industry, I asked myself: "What next?" I took time to look back at my past accomplishments, to see where I could push my boundaries. Then I remembered that as a kid I always wanted to be an astronaut. I realized that the aerospace industry had a lot to offer in terms of personal growth and career opportunities.<br /><br /><b>Why did you choose Concordia?</b><br />I chose Concordia because I wanted the training that would allow me to dive back into industry. The Industrial Experience program was the perfect fit. Although I have academic career aspirations, I like to work with things that are used in our everyday world by everyday people. Concordia offered this... and, as I soon learned, a lot more. Concordia has a good mix of instructors from both academia and industry, allowing one to apply the rigours of theory to practical situations.<br /><br /><b>What kind of student activities are you involved in?</b><br />On top of being a member of the Concordia Institute of Aerospace Design and Innovation, and the American Institute of Aeronautics and Astronautics, I am heavily involved with Space Concordia, a group of Concordia engineering students designing a satellite as part of an inter-university competition called the Canadian Satellite Design Challenge. The winning satellite will be sent into space!<br /><br />I also participated in the Beihang University Summer School of Aeronautics and Astronautics in Beijing, China. I really enjoyed the experience: its seminars, workshops, laboratory tours, and recreational activities. One of the main highlights was the visit to the Great Wall of China.<br /><br /><b>What kind of work-study experience have you had while at Concordia? </b><br />I did an internship at Rolls-Royce involving thermoacoustic modeling of the Industrial Trent gas turbine engine combustion system. Industrial gas turbine engines are used for power generation and have stringent environmental requirements. Just as you can turn down the fuel on your barbeque to reduce cost and pollution, so too can you do this on gas turbine engines. The problem is that the flame on your barbeque can sputter and make noise. This also affects gas turbine engines, and can lead to considerable damage within the combustion system (and downstream). In a nutshell, I modeled this behaviour to be able to adjust the fuel mixture so as to avoid damaging the engine parts. <br /><br />I am currently doing an internship at Bombardier on emerging technologies. Although it's not credited towards my degree, this job is amazing. I get to go wherever my curiosity takes me: nanotechnologies, superconductors, turbulence avoidance systems, plasma actuators, all-electric aircrafts, futuristic propulsion systems, smart windows, hypersonic flight, etc. <br /><br /><b>What are your plans after graduation? </b><br />I have recently become incorporated under the name Texidyme Solutions Inc. and plan to do general R&amp;D contracting, mainly in the aerospace and military industrial sectors. My future looks bright in this regard, as I am already starting to get some bites. As time goes on, I hope to one day employ people for contract work and general R&amp;D product design. <br /><b><br />Where do you see yourself in 10 years?</b><br />I tend to go with ebbs and flows on that great path of life. That said, I see myself as a successful businessperson with a good work-life balance, sharing my appetite for knowledge with others through teaching. I want to bring innovation to the world, and I want to continue to enjoy life and appreciate the universe and all it has to offer.<br /> 
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2011/11/graduate-student-spotlight-2.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Graduate Student Spotlight
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/index...ght-2.php </p>
