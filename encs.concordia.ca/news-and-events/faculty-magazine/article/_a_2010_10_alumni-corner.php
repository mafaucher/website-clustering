...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Ffaculty-magazine%2Farticle%2F%3Fa%3D2010%2F10%2Falumni-corner.php','%0AAlumni%20Corner%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2010/10/alumni-corner.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Get Connected </a>
	...
	<div id="maincontent"  class="topgutter"  >
		<div id="lh_menu_area">
		<div id="lh_menu">
<ul class="level_3"><li id="li_Fall2011_4"><a href="../issue.php_q_Fall_y_2011"><span>Fall 2011</span></a></li><li id="li_Summer2011_4"><a href="../issue.php_q_Summer_y_2011"><span>Summer 2011</span></a></li><li id="li_Winter2011_4"><a href="../issue.php_q_Winter_y_2011"><span>Winter 2011</span></a></li><li id="li_Fall2010_4"><a href="../issue.php_q_Fall_y_2010"><strong><span>Fall 2010</span></strong></a></li><li id="li_Spring2010_4"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/issue.php?q=Spring&y=2010"><span>Spring 2010</span></a></li><li id="li_Winter2010_4"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/issue.php?q=Winter&y=2010"><span>Winter 2010</span></a></li></ul></div>
	</div>
		<div class="insidecontent ">

			<p class="breadcrumb"><a href="../../../index.html">ENCS Home</a> &gt; <a href="../index.php">News &amp; events</a> &gt; <a href="index.php">Faculty Magazine</a> &gt; <a href="../issue.php_q_Fall_y_2010">Fall 2010</a> &gt;</p>
...
<i><b>Marinella Ermacora<br />Bachelor's in Computer Science - 1982</b></i><br /><br /><img alt="Marinella.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Marinella.jpg" class="mt-image-left" style="float: left; margin: 0pt 20px 20px 0pt;" height="331" width="220" />"Work hard and you can achieve anything" may sound like a cliché but for Marinella Ermacora it's a statement of fact. As a student in the Department of Computer Science and Software Engineering, that work ethic was necessary to succeed. Moving through the ranks of Bell Canada and then CGI, that same attitude was a key factor in forming an impressive career path.<br /><br />The child of Italian immigrants, Marinella came to Montreal at a young age. While her parents were always supportive of her dreams, they never thought she would go to university. "My father had the typical expectation that I would just get married and start a family," Marinella recalls. It was when she won a CEGEP scholarship that her parents truly realized their daughter was driven to succeed. <br />After finishing her studies at Vanier College, Marinella chose to pursue Computer Science at Concordia. "I had enjoyed computer science at Vanier and it seemed like a good idea" recalls Marinella, whose brother encouraged her to check out Concordia. Before long, Marinella was buried in books and actively studying with a tight-knit group of international friends.&nbsp; <br /><br />She graduated top of her class in 1982 and was awarded the computer science medal. Making the transition to the working world was a snap for Marinella, who was recruited by several companies before graduation. Bell Canada seemed a logical choice, as she relished the opportunity to learn on the job. "What definitely attracted me to Bell was its focus on continuing education," recalls Marinella, who soon decided to go back to school--this time to McGill for an MBA. Bell encouraged her in the endeavour, allowing her to pursue her studies part-time. Finding the combined demands of high-pressure work and studies to be too much, Marinella took a year of leave to finish her degree through an exchange program with the HEC in Paris. <br />After a year spent perfecting her French and completing her MBA, Marinella headed back to Bell. She recalls that time with great fondness, explaining, "I was always honoured with great challenges, and always had great fun and worked hard like I did at Concordia. That was one of the first lessons: the busy people get even more opportunities to contribute, which I found true at Concordia." <br /><br />In 1998, Marinella joined the ranks of CGI, along with 3,800 other employees from Bell, which at the time was CGI's largest outsourced contract. Although she briefly left CGI to lead the operations of a Bell subsidiary, she was returned in 2002, at which time became the account executive of the Desjardins account and eventually brought her management expertise to the position of Senior Vice President in CGI's Human Resources department. Although she has truly enjoyed her time with CGI, Marinella is now looking for the next challenge along her career path. <br />"No matter where I go after CGI and I part ways," says Marinella with confidence, "I'll remain close to Concordia." As part of this Faculty's Industrial Advisory Committee, she has had the opportunity to be directly involved in the ongoing dialogue between industry and the Faculty of Engineering and Computer Science. "I found Concordia gave so much to me. I want to give back!" says Marinella with a broad smile. <br /><br />Marinella also displays her attitude that "hard work pays off" in her community engagement, as she is a Board member of the Montreal Nature Museums Foundation and the Corporation du Collège de Montréal. She is an executive member of the Fédération des chambres de commerce du Québec and a member of the Board of Directors of the Foundation of the Institut de recherches cliniques de Montréal. She hopes to impart this work ethic to her two sons, young adults with solid aspirations. Asked what's next, Marinella gives a carefree shrug. "Who knows? Maybe a PhD! Why not? I've always loved studying." <br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/?a=2010/10/alumni-corner.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Alumni Corner
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/faculty-magazine/article/index...orner.php </p>
