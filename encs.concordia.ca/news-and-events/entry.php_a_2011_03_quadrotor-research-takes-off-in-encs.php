...
<head>
	...
	<title>
Quadrotor research takes off in ENCS
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F03%2Fquadrotor-research-takes-off-in-encs.php','%0AQuadrotor%20research%20takes%20off%20in%20ENCS%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/quadrotor-research-takes-off-in-encs.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Quadrotor research takes off in ENCS
			...
			<div class="entry-meta" title="2011-03-22T12:56:50-05:00">Tuesday Mar 22, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<font style="font-size: 0.8em;"><i>by Russ Cooper</i></font><br /><br />The first day of the class, there were students who couldn't believe their eyes. Many even broke out their phones to capture video for friends who probably wouldn't imagine something so cool.<br /><br />For the <a href="http://www.me.concordia.ca/">Mechanical and Industrial Engineering</a> students at Concordia, this was heaven.<br /><br />That's because for the first time anywhere, the <a href="http://www.quanser.com/english/html/UVS_Lab/fs_Qball_X4.htm">Quanser Qball-X4</a> - a 1.4-kilogram quadrotor helicopter with four 25-centimetre propellers protected by a one-metre diameter, 80-sided (octacontagon) carbon fibre cage - is being used as a teaching tool.<br /><br /><iframe title="YouTube video player" src="http://www.youtube.com/embed/9P7aHERdW8s?rel=0" allowfullscreen="" frameborder="0" height="278" width="440"></iframe><br /><br />In fact, this is the first time any quadrotor unmanned aerial vehicle (UAV) is being used in the classroom.<br /><br />"The purpose of the class, MECH 480/6091 - Flight Control Systems, is to teach students the concept of flight and flight dynamics, as well as how to design an autopilot," says Mechanical and Industrial Engineering professor <a href="http://users.encs.concordia.ca/%7Eymzhang/">Youmin Zhang</a>, who teaches the undergraduate course.<br /><br />The course itself is also pretty cool not only for its content, but for its breadth of student appeal. It welcomes third- and fourth-year undergraduates, and graduate students up to the doctoral level who are taking the course to boost their expertise.<br /><br />The five Qballs Concordia bought last fall give the class's 35 students a unique opportunity to develop automatic flight control functions for UAVs and to test them safely in a special teaching lab in the Henry F. Hall Building.<br /><br />Students aren't learning to control the quadrotor with a joystick. Rather, they develop algorithms that guide the helicopter along a preset path.<br /><br />To gauge the Qball's accuracy along its flight, the lab has six cameras capturing locations along x, y, and z axes. The data, complete with recordings of deviations due to environmental disturbances or formula flaws, is then compared with the original established path.<br /><br />Zhang is convinced that the knowledge and experience students gain could give them an edge in the aeronautics industry; knowing how to control UAVs means greatly reducing the risk of human casualties in many airborne applications.<br /><br />Real-world use of these algorithms in UAVs includes the surveillance of treacherous terrain or disaster zones, guiding an aircraft accurately and safely from city to city, or even helping a plane stabilize and land safely after it loses a portion of a wing.<br /><br />For more on this project, check out the <a href="http://users.encs.concordia.ca/%7Eymzhang/teaching.html">online videos</a> of experiments in MECH 480/6091 Flight Control Systems.<br /><br /><hr><p><font style="font-size: 0.8em;"><i><a href="http://www.concordia.ca/now/what-we-do/research/20110321/four-times-the-fun.php">This story</a> originally appeared in the March 21 edition of the Concordia Journal.</i></font></p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/quadrotor-research-takes-off-in-encs.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Quadrotor research takes off in ENCS
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/03/quadrotor-r...-encs.php </p>
