...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F10%2Fbcee-member-presents-paper-in-india.php','%0ABCEE%20member%20presents%20paper%20in%20Indonesia%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/10/bcee-member-presents-paper-in-india.php#maincontent" accesskey="s">Skip to Content</a></li>
...
BCEE member presents paper in Indonesia
			...
			<div class="entry-meta" title="2010-10-01T16:58:04-05:00">Friday Oct  1, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<b>Nghi&nbsp; M. Nguyen</b> (<a href="http://www.bcee.concordia.ca/index.php/Main_Page">Building, Civil and Environmental Engineering</a>) presented a paper titled "The Development of an ISO Project Management Standard: A Global Challenge for Transferability of Management Systems and Technologies" at the XXVII Pan Pacific Business Conference in June in Bali, Indonesia.<br /><br />He also chaired the "Management of Technologies and Systems" session and is currently a member of the Canadian Advisory Council (CAC) contributing inputs to the development of this internationally recognized standard, ISO 21500, which has been developing by the International Organization for Standardization since 2007 with participation of experts from thirty one countries worldwide and is anticipated to be completed by 2012. The standard will eventually impact project management practice around the world.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/10/bcee-member-presents-paper-in-india.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
BCEE member presents paper in Indonesia
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/10/bcee-member...india.php </p>
