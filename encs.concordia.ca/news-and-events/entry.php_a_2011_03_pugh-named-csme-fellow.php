...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F03%2Fpugh-named-csme-fellow.php','%0APugh%20named%20CSME%20Fellow%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/pugh-named-csme-fellow.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Pugh named CSME Fellow
			...
			<div class="entry-meta" title="2011-03-24T11:40:57-05:00">Thursday Mar 24, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="Pugh.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Pugh.jpg" class="mt-image-left" style="float: left; margin: 0pt 20px 20px 0pt;" width="171" height="258" /><a href="http://users.encs.concordia.ca/%7Epugh/">Dr. Martin Pugh</a>, Chair of the <a href="http://www.me.concordia.ca/index.php">Department of Mechanical and Industrial Engineering</a> has been named a Fellow of the <a href="http://www.csme-scgm.ca/">Canadian Society for Mechanical Engineering</a> (CSME). The recognition honours Pugh's "excellence in mechanical engineering and for your significant contributions to the profession," explains Marius Paraschivoiu, Chair of the CSME Honours and Awards Committee.<br /><br />The CSME is a society that brings together all mechanical engineering personnel, and engineers in other disciplines with interest in mechanical engineering. Affiliated with the Engineering Institute of Canada, the society organizes conferences and forums for the members to meet and discuss issues of common concern of the day to mechanical engineers. Its mission is to foster excellence in the practice of mechanical engineering for the benefit of Canada and the world, and to serve and support our members.<br /><br />An award ceremony honouring the newly named Fellows of the CSME will be held in Vancouver in June.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/pugh-named-csme-fellow.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Pugh named CSME Fellow
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/03/pugh-named-...ellow.php </p>
