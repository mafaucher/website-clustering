...
<head>
	...
	<title>
Peter Grogono on Software and Society
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F03%2Fpeter-grogono-on-software-and-society.php','%0APeter%20Grogono%20on%20Software%20and%20Society%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/03/peter-grogono-on-software-and-society.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Peter Grogono on Software and Society
			...
			<div class="entry-meta" title="2010-03-09T16:54:23-05:00">Tuesday Mar  9, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
On March 4, as part of the activities organized by the Engineering and Computer Science Alumni Chapter (ECAC) for Engineering Week, Dr. Peter Grogono led a fascinating conversation with a rapt audience on the timely subject of software &amp; society.<br /><br /><div align="center"><img alt="Peter Grogono & ECAC" src="http://newsfeed.encs.concordia.ca/encs_test/grogono-talk.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" height="163" width="440" /><i>Above: Peter Grogono flanked by members of the ECAC Executive.</i><br /></div><br />Grogono, who is a Professor in the Department of Computer Science and Software Engineering, subtitled his talk "the good, the bad, and the ugly" and began the session with examples from all three of these categories. On the side of the good, Grogono cited applications like website search engines, GPS units, online banking, and medical imaging. When it came to the bad, Grogono (who quipped, "I won't even mention Microsoft Word") took aim at software with inadequate or nonexistent supporting documentation--programs written with instruction manuals that are simply impossible to follow. As for the ugly, Grogono used the familiar example of the malware that is deliberately made to infect the average personal computer and steal private information from its hard drive. <br /><br />Once that groundwork had been laid, the conversation was opened up to involve the entire audience. Questions, answers, comments, and postulations were fast-flowing within an interested and informed group that came to the talk prepared to engage with each other as well as with Professor Grogono. The conversation grew and evolved as the discussions touched on subjects ranging from Swiss Army knives to Apple iPhones, and everyone seemed to leave the conference room smiling broadly.<br /><br /><div align="center"><img alt="ECA Wine and Cheese" src="http://newsfeed.encs.concordia.ca/encs_test/wine-cheese.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" height="315" width="440" /><i>Above: Dean Robin Drew shares a drink and a laugh with current and former students.</i><br /></div><br />In the EV atrium, audience members--who were mostly made up of ENCS alumni--found even more to smile about: a wine and cheese organized by the Engineering and Computer Science Association (ECA). Former students mingled with current undergrads, as well as with some Faculty members including Dean Drew, sharing drinks and snacks, and continuing the conversation well into the night.&nbsp; <br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/03/peter-grogono-on-software-and-society.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Peter Grogono on Software and Society
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/03/peter-grogo...ciety.php </p>
