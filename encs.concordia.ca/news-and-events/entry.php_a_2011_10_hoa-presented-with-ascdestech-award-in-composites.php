...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F10%2Fhoa-presented-with-ascdestech-award-in-composites.php','%0AHoa%20wins%20ASC%2FDEStech%20Award%20in%20Composites%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/10/hoa-presented-with-ascdestech-award-in-composites.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Hoa wins ASC/DEStech Award in Composites
			...
			<div class="entry-meta" title="2011-10-04T09:29:54-05:00">Tuesday Oct  4, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="Hoa3.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Hoa3.jpg" class="mt-image-right" style="float: right; margin: 0pt 0pt 20px 20px;" width="220" height="346" />Congratulations to <a href="http://users.encs.concordia.ca/%7Ehoasuon/">Suong Van Hoa</a>, Professor in the <a href="http://www.me.concordia.ca/">Department of Mechanical and Industrial Engineering</a>, who was presented with the ASC/DEStech award in Composites by the American Society for Composites. The award was granded to Hoa in recognition of his significant impact on the development of composite materials through applied research, practice, education, service, advocacy, and leadership. <br /><br />The award was presented on September 27, during the 26th ASC Annual Technical Conference (the Second Joint US-Canada Conference on Composites), which was held in Montreal from September 26- 28, 2011. The conference marked the continuing effort in collaborative research between the two countries and was jointly sponsored by the American Society for Composites and the Canadian Association for Composite Structures and Materials. <br /><br />The American Society for Composites is an all-volunteer group of dedicated professionals in academia, industry, national laboratories, and federal agencies.The society's mission is to provide a communication forum for the engineering and scientific community in composite materials; to expedite the growth of knowledge gained from inter-disciplinary engineering and scientific research in composite materials; and to promote the exploitation of the unique properties of composite materials in emerging applications. For more on the ASC, visit their <a href="http://www.asc-composites.org/">official website</a>.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/10/hoa-presented-with-ascdestech-award-in-composites.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Hoa wins ASC/DEStech Award in Composites
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/10/hoa-present...sites.php </p>
