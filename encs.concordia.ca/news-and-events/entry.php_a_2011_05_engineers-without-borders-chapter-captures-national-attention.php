...
<head>
	...
	<title>
Engineers Without Borders chapter captures national attention
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F05%2Fengineers-without-borders-chapter-captures-national-attention.php','%0AEngineers%20Without%20Borders%20chapter%20captures%20national%20attention%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/05/engineers-without-borders-chapter-captures-national-attention.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Engineers Without Borders chapter captures national attention
			...
			<div class="entry-meta" title="2011-05-16T15:58:12-05:00">Monday May 16, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
The Concordia Chapter of Engineers Without Borders has captured the attention of nonprofit organization, Fairtrade Canada. Last week, the official Fairtrade website featured an article entitled "Concordia Sets Goal to Be Fair Trade Campus," by Camille Jensen. <br /><br /><div align="center"><img alt="ewb.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/ewb.jpg" class="mt-image-center" style="text-align: center; display: block; margin: 0pt auto 20px;" width="491" height="330" /><i><font style="font-size: 0.8em;">Representatives of EWB Concordia gathered together last November for a special celebration</font></i><br /></div><br />The article features interviews with Jad Saleh (President of EWB Concordia) and Deborah Dysart-Gale (Chair of the Centre for Engineering in Society). <br /><br />You can check out the full article <a href="http://fairtrade.ca/en/news-views/news/concordia-sets-goal-be-fair-trade-campus">here</a>.<br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/05/engineers-without-borders-chapter-captures-national-attention.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Engineers Without Borders chapter captures national attention
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/05/engineers-w...ntion.php </p>
