...
<head>
	...
	<title>
Major support for aerospace teaching
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F03%2Fmajor-support-announced-for-aerospace-teaching.php','%0AMajor%20support%20for%20aerospace%20teaching%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/major-support-announced-for-aerospace-teaching.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Major support for aerospace teaching
			...
			<div class="entry-meta" title="2011-03-15T08:57:10-05:00">Tuesday Mar 15, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="aero-announce.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/aero-announce.jpg" class="mt-image-right" style="float: right; margin: 0pt 0pt 20px 20px;" height="391" width="220" />On Monday, March 14, Madame Line Beauchamp, Quebec's minister of <a href="http://www.mels.gouv.qc.ca/">Education, Recreation, and Sports</a> held a special press conference announcing the creation of a brand new aerospace teaching laboratory. The Government of Quebec has invested $5 million in this exciting project, which marks the first time in North America that a group of universities has had at their disposal a common laboratory facility for testing flight control systems using realistic aerodynamic loads applied to the control surfaces.<br /><br />The Laboratoire d'enseignement des systèmes intégrés en aérospatiale du Québec, or Quebec laboratory for integrated aerospace systems teaching, will be equipped with two testing platforms: one, an iron bird test apparatus, which tests flight control systems for a Challenger aircraft model under realistic aerodynamic loads (worth $20 M and donated by Bombardier Aerospace); the other, a Bell 427 helicopter valued at $250,000 and donated by Bell Helicopter Textron.<br /><br />The lab will be situated in a hangar that belongs to the Commission scolaire de Montreal and will be managed by Montreal's �0cole Polytechnique. The lab will be used for teaching in aerospace by five other Québec universities: �0cole de technologie supérieure, McGill, Laval, Sherbrooke--and, of course, Concordia. <br /><br /><a href="../administration-and-governance/about-the-dean/index.html">Dr. Robin A. L. Drew</a>, Dean of Concordia's Faculty of Engineering and Computer Science, is particularly pleased with the announcement, noting that it will "greatly benefit both students and professors affiliated with our faculty's aerospace initiatives, which are embodied by the <a href="http://ciadi.concordia.ca/">Concordia Institute for Aerospace Design and Innovation</a>." <br /><br />Luis Rodrigues, an Associate Professor in the Concordia Institute for Aerospace Design and Innovation, also attended the press conference, echoes Dean Drew's sentiments. He adds that this "is a very important step towards bringing together industry, universities and Montreal's School Board for the training of students in aerospace integrated systems."<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/03/major-support-announced-for-aerospace-teaching.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Major support for aerospace teaching
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/03/major-suppo...ching.php </p>
