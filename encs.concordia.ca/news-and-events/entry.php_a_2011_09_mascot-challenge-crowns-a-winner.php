...
<head>
	...
	<title>
Mascot Challenge crowns a winner
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F09%2Fmascot-challenge-crowns-a-winner.php','%0AMascot%20Challenge%20crowns%20a%20winner%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/09/mascot-challenge-crowns-a-winner.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Mascot Challenge crowns a winner
			...
			<div class="entry-meta" title="2011-09-27T14:09:31-05:00">Tuesday Sep 27, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
Meeting new friends and feeling part of a new community during a student's first few weeks at university can sometimes seem harder than midterms! Luckily for first year students in the Faculty of Engineering and Computer Science, the first annual Mascot Challenge came along to help solve the problem.<br /><br />The event, which involved building a mascot out of discarded computer parts, drew many enthusiastic first-year students, who spent the morning working together on their mascots while on-lookers who happened to be passing through the EV atrium craned their necks to get a better look at what was going on. <br /><br /><object width="400" height="300"> <param name="flashvars" value="offsite=true&amp;lang=en-us&amp;page_show_url=%2Fphotos%2Fencs-concordia%2Fsets%2F72157627757500216%2Fshow%2F&amp;page_show_back_url=%2Fphotos%2Fencs-concordia%2Fsets%2F72157627757500216%2F&amp;set_id=72157627757500216&amp;jump_to=" /> <param name="movie" value="http://www.flickr.com/apps/slideshow/show.swf?v=107931" /> <param name="allowFullScreen" value="true" /><embed type="application/x-shockwave-flash" src="http://www.flickr.com/apps/slideshow/show.swf?v=107931" allowfullscreen="true" flashvars="offsite=true&lang=en-us&page_show_url=%2Fphotos%2Fencs-concordia%2Fsets%2F72157627757500216%2Fshow%2F&page_show_back_url=%2Fphotos%2Fencs-concordia%2Fsets%2F72157627757500216%2F&set_id=72157627757500216&jump_to=" width="400" height="300"></object><br /><br />When the clock ran out, a group of distinguished judges assembled to select a winner... but the decision proved too difficult and, ultimately, a tie was announced. The members of the two winning teams were each awarded $200 gift certificates to the Concordia bookstore for their mascots, who were named "Duck Tape" and "Angry Bird." Runners up received $50 gift certificates.<br /><br />The event (which was generously supported by the Office of the Vice Provost of Teaching and learning) was organized by Nancy Acemian, Lecturer in the Department of Computer Science &amp; Software Engineering as well as the Faculty's new First Year Director. She hopes that year's Mascot Challenge will be the first of many. Although this first installation was only open to first year Computer Science and Software Engineering undergraduates, Acemian plans to expand the event to include other departments in the Faculty of Engineering and Computer Science in years to come.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/09/mascot-challenge-crowns-a-winner.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Mascot Challenge crowns a winner
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/09/mascot-chal...inner.php </p>
