...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F03%2Fencs-hosts-bridge-competition---on-now.php','%0ATroitsky%20Bridge%20Competition%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/03/encs-hosts-bridge-competition---on-now.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Troitsky Bridge Competition
			...
			<div class="entry-meta" title="2010-03-05T13:16:50-05:00">Friday Mar  5, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
The <a href="http://troitsky.ca/"><b>2010 Troitsky Bridge Building Competition</b></a> was held on Friday, March 5 at Concordia's Faculty of Engineering and Computer Science. 30 teams of undergraduate engineering students from universities ranging from Carleton to Calgary, McMaster to Vermont came to Concordia to participate in the annual competition, which is now in its 26th year.<br /><br /><img alt="Troitsky Bridge Building Competition" src="http://newsfeed.encs.concordia.ca/encs_test/bridges1.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" height="220" width="440" />Using only Popsicle sticks, white school glue and dental floss, the teams were given just two hours to build a bridge that could withstand a heavy load while taking efficiency, originality, and aesthetics into account. When the whistle sounded just after 11 a.m., it was "all hands off bridge" in order for the judging to begin. <br /><br /><div align="center"><img alt="Troitsky Bridge Building Competition" src="http://newsfeed.encs.concordia.ca/encs_test/bridgesjudges.jpg" class="mt-image-none" style="" height="220" width="440" /><br /></div><br />The event's 3 judges were <b>Andy Woo </b>from the Jacques Cartier and Champlain Bridges Inc.; <b>Pierre-Albert Jean </b>from Construction Albert Jean Ltd.; and <b>Richard Veradi </b>from Group Canvar Inc. They toured the entries, judging the bridges based aesthetics &amp; originality of the idea, and booth layout &amp; presentation. Both Veradi and Jean are ENCS alumni and were happy to be back at their alma mater. Veradi, who had volunteered at the Troitsky event while a student, noted that the event had come a long way since his days at Concordia and praised the participants for their excellent work.<br /><br /><img alt="Troitsky Bridge Building Competition" src="http://newsfeed.encs.concordia.ca/encs_test/bridges2.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" height="312" width="440" />During afternoon, the infamous <b>Crusher</b> became the fourth and final judge as it tested the bridges for ultimate load carrying capacity and structural efficiency. This part of the event was the loudest and most raucous as teams cheered while the bridges cracked under pressure. The winning team was the League of Extraordinary Gentlemen from McMaster University, with an overall score of 92.49 out of 100. Concordia's team, the Troitskyites (pictured above), placed 21st.<br /><br />Be sure to check out the event photos on our <b><a href="http://www.flickr.com/photos/encs-concordia/sets/72157623435982435/">Flickr page.</a></b><br /><div><br /></div><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/03/encs-hosts-bridge-competition---on-now.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Troitsky Bridge Competition
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/03/encs-hosts-...n-now.php </p>
