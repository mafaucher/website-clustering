...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F02%2Fathienitis-hosts-ecac-event-on-solar-energy.php','%0AAthienitis%20hosts%20ECAC%20event%20on%20solar%20energy%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/02/athienitis-hosts-ecac-event-on-solar-energy.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Athienitis hosts ECAC event on solar energy
			...
			<div class="entry-meta" title="2010-02-17T21:22:51-05:00">Wednesday Feb 17, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
Well over 50 enthusiastic alumni, students, and industry professionals came to visit the EV and JMSB buildings on Wednesday, 17 February, in order to attend a special lecture and tour presented by Dr. Andreas Athienitis, Senior Director of the Concordia-based <a href="http://www.solarbuildings.ca/en/network">Solar Buildings Research Network</a> (SBRN). <br /><br /><img alt="Athienitis-Alumni-talk-web2.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Athienitis-Alumni-talk-web2.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" width="440" height="324" />Athienitis, a professor in the <a href="http://www.bcee.concordia.ca/index.php/Main_Page">Department of Building, Civil and Environmental Engineering</a> and a globally recognized expert on the subject of solar energy, began the evening with a detailed presentation on his research into the subject of renewable energy. He spoke of the SBRN, which has as its goal the development of the solar-optimized building as an integrated advanced technological system that approaches net-zero energy consumption while being cost effective and comfortable. He then detailed some of the projects the Network had undertaken, including the extremely innovative solar wall project atop Concordia's JMSB building (opened in 2009).<br /><br /><img alt="Athienitis-Alumni-talk-web1.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/Athienitis-Alumni-talk-web1.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" width="440" height="245" />Athienitis, with the help of his dedicated undergraduate student <b>James Bambara</b>, then led the assembled group on a fascinating tour of the solar wall itself. He took attendees up to the 16th floor of the JMSB building and showed the inner workings of the cutting-edge installation while answering a host of intelligent questions on the varied applications of solar energy.<br /><br />The event was organized by the <b>Engineering and Computer Science Alumni Chapter </b>(ECAC). For more on the Chapter and their upcoming events, visit their <a href="http://alumni.concordia.ca/chapters/faculty/EC/">official website</a>.<br /><br />For more on the solar wall project, be sure to read the "<a href="http://cjournal.concordia.ca/archives/20091001/spotlight_on_solar_panels.php">Spotlight on Solar Panels</a>" article published in the Concordia Journal in October 2009.<br /><br />For more photos from the event, check out the <a href="http://www.flickr.com/photos/encs-concordia/">ENCS Flickr page</a>!<br /><br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/02/athienitis-hosts-ecac-event-on-solar-energy.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Athienitis hosts ECAC event on solar energy
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/02/athienitis-...nergy.php </p>
