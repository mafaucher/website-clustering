...
<head>
	...
	<title>
Faculty hosts professionalism & ethics session
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2010%2F09%2Ffaculty-hosts-professionalism-ethics-session.php','%0AFaculty%20hosts%20professionalism%20%26%20ethics%20session%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/09/faculty-hosts-professionalism-ethics-session.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Faculty hosts professionalism & ethics session
			...
			<div class="entry-meta" title="2010-09-29T14:32:58-05:00">Wednesday Sep 29, 2010</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="logo_oiq.gif" src="http://newsfeed.encs.concordia.ca/encs_test/logo_oiq.gif" class="mt-image-left" style="margin: 0pt 20px 20px 0pt; float: left;" width="221" height="94" />On September 27, the Faculty of Engineering and Computer Science was pleased to host a day on "Professionalism and Ethics in Engineering for Professors, organized by the Ordre des Ingenieurs du Quebec.<br /><br />21 participants attended the daylong session, which featured a talk by Mr. Richard Thibault, ing. All attendees received an individual certificate of training for having taken part.<br /><br />Professionalism and ethics in engineering are of great importance to this Faculty, as it seeks to help its students incorporate these concepts into their studies and future careers.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2010/09/faculty-hosts-professionalism-ethics-session.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Faculty hosts professionalism & ethics session
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2010/09/faculty-hos...ssion.php </p>
