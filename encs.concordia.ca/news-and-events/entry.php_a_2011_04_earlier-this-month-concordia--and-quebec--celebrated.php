...
<head>
	...
	<title>
Concordia team takes off in Arizona
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F04%2Fearlier-this-month-concordia--and-quebec--celebrated.php','%0AConcordia%20team%20takes%20off%20in%20Arizona%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/04/earlier-this-month-concordia--and-quebec--celebrated.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Concordia team takes off in Arizona
			...
			<div class="entry-meta" title="2011-04-28T10:35:03-05:00">Thursday Apr 28, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
Earlier this month, Concordia--and Quebec--celebrated a milestone: a group of our students became the first in the province to participate in the internationally renowned <a href="http://www.aiaadbf.org/">Cessna/Raytheon Missile Systems Student Design/Build/Fly competition</a>, hosted by the <a href="http://www.aiaa.org/">American Institute of Aeronautics and Astronautics</a>. This year's event was held on April 15 in sunny Tucson, Arizona and brought together international talents from various universities from countries around the world including Italy, Slovenia, Turkey, Israel, the UAE, and beyond! <br /><a href="http://newsfeed.encs.concordia.ca/encs_test/CASI-1.jpg"><br /></a><div align="center"><img alt="CASI-1.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/CASI-1.jpg" class="mt-image-center" style="text-align: center; display: block; margin: 0pt auto 20px;" width="440" height="662" /><font style="font-size: 0.8em;"><i>The Concordia Team poses in Tucson -&nbsp; from left to right: Jordan Lafreniere, Nicholas Major, Serge Kudinov, Hadi Alaee, Andrew Romano, Quan Pham</i></font><br /><br /></div>82 teams were put to the test in Tucson, proving their design, manufacturing, and flight capabilities with electric-powered and radio-controlled unmanned aerial vehicles. Under the dedicated supervision of <a href="http://www.me.concordia.ca/">Mechanical and Industrial Engineering</a> professor Hoi Dick Ng, the Concordia team ensured their project conformed to the competition's tight constraints.<br /><br />After the Concordia entry passed its meticulous inspection after the first round (a feat which only half of the teams manage), the aircraft had to complete three missions:<br /><br /><ol><li>Dash to critical target: complete as many laps as possible in 4 minutes. </li><li>Ammo re-supply: carry the heaviest steel bar possible</li><li>Medical Supply Mission: carry as many golf balls as possible</li></ol><br />After completing 5 laps, carrying 2.2 lbs of steel, and hauling 18 golf balls, the Concordia team (composed of seven students from the Faculty of Engineering and Computer Science and the <a href="http://www.casi.ecaconcordia.ca/">Concordia branch of the Canadian Aeronautics and Space Institute</a>) was ranked 22nd. Team captain Hadi Alaee was pleased with the result, noting that "overall, the team's performance in this year's competition was perfect, considering we participated for the first time and we were the only Canadian team. There were minor details we were not aware of, which could have made a big difference in our performance. Still, I am happy with the results we got, and I am confident Concordia will do much better next year. Our team worked hard, and we couldn't have done it without our supervisor, Dr. Ng."<br /><br /><div align="center"><img alt="CASI-2.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/CASI-2.jpg" class="mt-image-center" style="text-align: center; display: block; margin: 0pt auto 20px;" width="440" height="292" /><font style="font-size: 0.8em;"><i>The Concordia UAV flies high in the Arizona sun</i><br /><br /></font><div align="left"><font style="font-size: 1em;">Special thanks to event sponsors: The Engineering and Computer Science Association, the Concordia faculty of Engineering and Computer Science, Concordia Institute of Aerospace Design and Innovation (CIADI),&nbsp; Consortium for Research and Innovation in Aerospace in Quebec (CRIAQ), Mechtronix, Bombardier Aerospace, The Concordia Council on Student Life (CCSL), Dassault Systemes, Eagle Tree Systems, Fat Shark, RPT Motion</font><font style="font-size: 1.25em;">.</font><br /><font style="font-size: 0.8em;"></font></div></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/04/earlier-this-month-concordia--and-quebec--celebrated.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Concordia team takes off in Arizona
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/04/earlier-thi...rated.php </p>
