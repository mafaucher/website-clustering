...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2011%2F10%2Fkishk-named-canada-research-chair.php','%0AKishk%20named%20Canada%20Research%20Chair%20%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/10/kishk-named-canada-research-chair.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Kishk named Canada Research Chair 
			...
			<div class="entry-meta" title="2011-10-13T09:24:27-05:00">Thursday Oct 13, 2011</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
<img alt="ahmed-kishk-web.jpg" src="http://newsfeed.encs.concordia.ca/encs_test/ahmed-kishk-web.jpg" class="mt-image-right" style="float: right; margin: 0 0 20px 20px;" height="258" width="220" />Dr. Ahmed Kishk, Professor in the <a href="http://www.ece.concordia.ca/">Department of Electrical and Computer Engineering</a>, was one of seven Concordia University professors to have received new funding to advance research from the federal government's <a href="http://www.chairs-chaires.gc.ca/">Canada Research Chairs</a> program. Following the recommendation of a peer committee, Chairs were awarded to the select group of Concordia professors who are considered leaders in their field. The announcement was made at Concordia in the presence of Senator Larry Smith and Chad Gaffield, president of the the Social Sciences and Humanities Research Council of Canada and head of the Canada Research Chairs Program Steering Committee.<br /><br />Kishk received his Canada Research Chair in Advanced Antenna Systems (Tier 1). His goal is to develop miniaturized antennas for smart phones that cover multiple frequency bands and can harvest solar energy to recharge batteries. He'll also investigate how to produce affordable, anti-collision radars for vehicles and microwave sensors for biomedical applications in cancer detection.<br /><br />For each Tier 1 Chair, the university receives $200,000 annually for seven years. Professors granted a Canada Research Chair were also eligible for infrastructure support from the <a href="http://www.innovation.ca/">Canada Foundation for Innovation</a> (CFI). The CFI awarded a total of almost $2 million for the new chairs to acquire the latest equipment for their research -- an amount matched by the <a href="http://www.mels.gouv.qc.ca/">Ministère de l'�0ducation, du Loisir et du Sport du Québec</a>. A further $500,000 was provided through in-kind support from equipment suppliers.<br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2011/10/kishk-named-canada-research-chair.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Kishk named Canada Research Chair 
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2011/10/kishk-named...chair.php </p>
