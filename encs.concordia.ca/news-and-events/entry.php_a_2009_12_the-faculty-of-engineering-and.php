...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2009%2F12%2Fthe-faculty-of-engineering-and.php','%0A%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/12/the-faculty-of-engineering-and.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<!-- InstanceBeginEditable name="maincontent" --><!-- FCKEDITOR_maincontent --><!-- /FCKEDITOR_maincontent -->
	...
	<div id="entry-58">
		<div class="entry-header">
			...
			<div class="entry-meta" title="2009-12-02T18:10:33-05:00">Wednesday Dec  2, 2009</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
The Faculty of Engineering and Computer Science is delighted to announce that a project involving our own <b>Dr. Van Suong Hoa</b> and Montreal-based company<b> MPB Technologies</b> has been awarded a "Prix Partenariat Technologique" at the 19th gala of the <b>Association de la recherche industrielle du Québec</b>.<br /><br /><a href="http://newsfeed.encs.concordia.ca/encs_test/ADRIQ2.JPG"><img alt="ADRIQ" src="http://newsfeed.encs.concordia.ca/encs_test/assets_c/2010/01/ADRIQ2-thumb-440x330-79.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" width="440" height="330" /></a>The partnership between MPB and Concordia began in 2003 and has resulted in the development of innovative "self-healing" materials that can lengthen the lifespan of structures used in outer space. Explains Dr. Hoa, "in space, tiny particles like micrometeorites can cause damage to man made structures. By using self-healing materials like those we're working on, organizations such as the Canadian Space Agency can develop structures that will stand up better to the harsh conditions of space."<br /><br /><a href="http://newsfeed.encs.concordia.ca/encs_test/ADRIQ.JPG"><img alt="ADRIQ" src="http://newsfeed.encs.concordia.ca/encs_test/assets_c/2010/01/ADRIQ-thumb-440x330-81.jpg" class="mt-image-center" style="margin: 0pt auto 20px; text-align: center; display: block;" width="440" height="330" /></a>Dr. Hoa notes that since the partnership with MPB began, much progress with these self-healing materials has been made. In fact, he hopes to see the products he has helped create be tested in space in the near future. Asked what the ADRIQ award meant to him, Hoa smiled broadly and called the win "a great surprise."<br /><div><br /></div>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/12/the-faculty-of-engineering-and.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
 ...
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2009/12/the-faculty...g-and.php </p>
