...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fnews-and-events%2Fentry.php%3Fa%3D2009%2F12%2Fmajor-grant-for-mie-prof.php','%0AMajor%20grant%20for%20MIE%20Prof%0A', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/12/major-grant-for-mie-prof.php#maincontent" accesskey="s">Skip to Content</a></li>
...
Major grant for MIE Prof
			...
			<div class="entry-meta" title="2009-12-10T18:26:41-05:00">Thursday Dec 10, 2009</div>
		</div>
	
		<div class="entry-content">
			<div class="entry-body">
				
The Faculty of Engineering and Computer Science is delighted to announce a major funding grant for the research of <b>Professor Lyes Kadem</b>, Assistant Professor with the Department of Mechanical and Industrial Engineering. To support the research by Dr Kadem and his team, Concordia was awarded $108,052 by the <b>Canada Foundation for Innovation</b> and an equal amount from the <b>Minist√®re de l'√0ducation, du Loisir et du Sport</b> to build a state-of-the-art laboratory for cardiovascular fluid dynamics. This infrastructure includes a three-dimensional time-resolved particle image velocimetry (TR-PIV) system. Particle image velocimetry is a non-intrusive optical measurement technique allowing the determination of 2D or 3D instantaneous velocity fields.<br />&nbsp;<br />Cardiovascular diseases are the first cause of death in Canada and in many other industrial countries. The number of cases is expected to grow continuously as a consequence of population aging. To further understand the development and the consequences of cardiovascular diseases a multidisciplinary research approach using highly sophisticated infrastructure is needed.<br /><br />Dr. Kadem's research focuses on biomechanical engineering approaches through experimental and numerical studies of fluid mechanic principles that have already led to significant discoveries related to cardiovascular diseases. For example, fluid mechanic principles for the investigation of heart valve diseases allowed an improvement in the diagnosis of the pathologies affecting the heart valves and understanding their coupling with the disturbances in blood flow. <br />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/news-and-events/entry.php?a=2009/12/major-grant-for-mie-prof.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
...
Major grant for MIE Prof
 - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/news-and-events/entry.phpa=2009/12/major-grant...-prof.php </p>
