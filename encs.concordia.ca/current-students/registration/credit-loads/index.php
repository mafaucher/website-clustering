...
<head>
	...
	<title>Credit loads - Engineering &amp; Computer Science - Concordia University - Montreal, Quebec, Canada</title>
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fcurrent-students%2Fregistration%2Fcredit-loads%2Findex.php','Credit%20loads', '/');
					});
	}
...
<body id="body_li_credit-loads_3" class="li_mainmenu_current-students_1 li_submenu_registration_2 li_credit-loads_3" >
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/current-students/registration/credit-loads/index.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<a class="li_submenu_registration_2_a" href="../index.html">
Registration </a>
</li>
...
<li id="li_credit-loads_3"> <span>Credit loads</span> </li>
</ul>
</div>
	</div>
		<div class="insidecontent ">

			<p class="breadcrumb"><a href="../../../index.html">ENCS Home</a> &gt; <a href="../../index.php">Current students</a> &gt; <a href="../index.php">Registration</a> &gt; </p>
...
<!-- InstanceBeginEditable name="MainContent" -->
  <p>The maximum regular session course load for full-time students in the Extended Credit and Mature Student programs is 30 credits until they have completed all the courses required beyond those specified for their particular option in subsequent sections</p>
  <p>The fall-term and winter-term course loads of full-time students may be unbalanced by up to three credits without permission; further differences between the two terms require the permission of the Dean's Office.</p>
  <h2>Summer Registration</h2>
  <p>Summer registration is on a part-time basis only (maximum 8.5 credits, with no more than 4.5 credits in each summer term), with the exception of the following:</p>
  <ol>
    <li>Co-op students following the sequence recommended by their Department</li>
    <li>Students entering the Faculty in the proceeding January session who are required to take a full-time summer course load</li>
    <li>Potential graduates who require a course to remain in sequence</li>
    </ol>
  <p>The 8.5 credit rule also applies to out-of-Faculty courses.</p>
  <p>Students wishing to take a full-course load who do not meet item 1 or item 2 must submit a written student request form to the Student Academic Services Office to be permitted to take more credits. Approval of course overloads during the summer is based on GPA, and proximity to graduation.</p>
  <p>Students in Building and Civil Engineering registering for CIVI 271 who wish to register for two additional courses in the summer must also advise Student Affairs in writing. </p>
<!-- InstanceEndEditable --><br class="hide" />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/current-students/registration/credit-loads/index.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Credit loads - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/current-students/registration/credit-loads/ind...hp </p>
