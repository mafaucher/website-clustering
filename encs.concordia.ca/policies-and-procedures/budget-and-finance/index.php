...
<head>
	...
	<title>Budget and finance - Engineering &amp; Computer Science - Concordia University - Montreal, Quebec, Canada</title>
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fpolicies-and-procedures%2Fbudget-and-finance%2Findex.php','Budget%20and%20finance', '/');
					});
	}
...
<body id="body_li_budget-and-finance_2" class="li_mainmenu_policies-and-procedures_1 li_submenu_budget-and-finance_2" >
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/policies-and-procedures/budget-and-finance/index.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<div class="submenu">
<ul id="ul_policies-and-procedures"> <li id="li_submenu_academic-personnel_2" >
<a class="li_submenu_academic-personnel_2_a" href="../academic-personnel/">
Academic personnel </a>
</li>
<li id="li_submenu_budget-and-finance_2" class="active">
<strong>Budget and finance </strong></li>
...
<a class="li_submenu_teaching_2_a" href="../teaching/">
Teaching </a>
</li></ul>
</div>
	<div id="maincontent"  class="topgutter"  >
		...
		<div id="lh_menu">
<ul class="level_3">
<li id="li_financial-support-for-faculty_3"> <a class="li_financial-support-for-faculty_3_a" href="financial-support-for-faculty/index.html">
<span>Financial support for faculty</span> </a>
</li>
<li id="li_professional-development-allowance_3"> <a class="li_professional-development-allowance_3_a" href="professional-development-allowance/index.html">
<span>Professional development allowance</span> </a>
</li>
<li id="li_purchasing_3"> <a class="li_purchasing_3_a" href="purchasing/index.html">
<span>Purchasing</span> </a>
</li>
<li id="li_travel_3"> <a class="li_travel_3_a" href="travel/index.html">
<span>Travel</span> </a>
</li>
</ul>
</div>
...
<!-- InstanceBeginEditable name="Sidebar" -->
	...
	<div class="sidebar_box_1">
		...
		<p>The Faculty's <a href="../../administration-and-governance/administrative-units/budget-office/index.html">Budget Office</a>  is responsible for designing and implementing Faculty procedures  that relate to the policies of Financial Services, Human Resources, and Purchasing Services.</p>
	</div>
    <div class="sidebar_box_1">
	  <h2>Contact:</h2>
		<ul>
		  <li>
		    <p> Sabrina Lavoie, <br />
		      ...
		      Faculty of Engineering and Computer Science, EV002.221 <br />
		      Tel. 514-848-2424 ext. 3061<br />
		      Fax 514-848-4509 <br />
		      Email: <a href="mailto:controller@encs.concordia.ca">controller@encs.concordia.ca</a> </p>
	      </li>
		  <li>Caroline Clayton, <br />
        Budget Assistant<br />
		      Faculty of Engineering and Computer Science, EV002.217<br />
		      Tel. 514-848-2424 ext. 5969<br />
          Fax 514-848-4509 <br />
		      Email: <a href="mailto:caroline@encs.concordia.ca">caroline@encs.concordia.ca</a> 
            <br />
            <br />
          </li>
		  <li>Josie Frazetto, <br />
		      Budget Assistant<br />
          Faculty of Engineering and Computer Science, EV002.219 <br />
		      Tel. 514-848-2424 ext. 4185<br />
		      Fax 514-848-4509 <br />
		      Email: <a href="mailto:josie@encs.concordia.ca">josie@encs.concordia.ca</a> 
	      </li>
	  </ul>
		<p>&nbsp;</p>
	</div>
...
<!-- InstanceBeginEditable name="MainContent" -->
  <p>The Budget Office assists in monitoring the Operating, Capital and  Trust Fund accounts. It is responsible for designing and implementing  Faculty procedures that relate to the policies of Financial Services,  Human Resources, and Purchasing Services.</p>
  
  <p>In this area of the website, you can find out more about:</p>
  
  <h2>Financial support for faculty</h2>
  <p>There are several <a href="financial-support-for-faculty/index.html">options for financial support</a> offered to tenured, tenure-track or ETA members of the Faculty of Engineering and Computer Science. </p>
  
  <h2>The Professional Development Allowance</h2>
  <p>The <a href="professional-development-allowance/index.html">professional development allowance</a> is available for legitimate expenditures relating to a Professor's teaching or research activities. </p>
  
  <h2>Purchasing</h2>
  <p>This page about <a href="purchasing/index.html">purchasing</a> will give you an overview of the responsibilities of Concordia University's Purchasing Department and the procedures for acquiring goods and services for the University Community.</p>
  
  <h2>Travel and Conference Support</h2>
  <p>This page links to the travel section of the University's Financial Services website and offers downloadable Travel Vouchers and Dean's Travel Funds Request forms. The page also gives details on the rules for conference support from the Faculty of Engineering and Computer Science. Find out more about <a href="travel/index.html">procedures relating to travel and conferences</a>.</p>
  <h2>Sabbatical and Moving Allowance</h2>
  <p>These subsections of the travel page deal with the <a href="http://www.encs.concordia.ca/policies-and-procedures/budget-and-finance/travel/#Sabbatical">sabbatical allowance</a> available to faculty members, as well as with the <a href="http://www.encs.concordia.ca/policies-and-procedures/budget-and-finance/travel/#Moving">moving allowance</a> allocated to new tenure track faculty members who are relocating to the Montreal area. </p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/policies-and-procedures/budget-and-finance/index.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Budget and finance - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/policies-and-procedures/budget-and-finance/ind...hp </p>
