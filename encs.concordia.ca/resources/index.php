...
<head>
	...
	<title>Resources - Engineering &amp; Computer Science - Concordia University - Montreal, Quebec, Canada</title>
...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Fresources%2Findex.php','Resources', '/');
					});
	}
...
<body id="body_li_resources_1" class="li_mainmenu_resources_1" >
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/resources/index.php#maincontent" accesskey="s">Skip to Content</a></li>
...
<li id="li_mainmenu_resources_1" class="active">
...
<div class="submenu">
<ul id="ul_resources"> <li id="li_submenu_schedules_2" >
<a class="li_submenu_schedules_2_a" href="http://www.encs.concordia.ca/resources/schedules/">
Schedules </a>
</li>
<li id="li_submenu_faculty-and-staff-directory_2" >
<a class="li_submenu_faculty-and-staff-directory_2_a" href="http://www.encs.concordia.ca/resources/faculty-and-staff-directory/">
Faculty &amp;<br />staff directory </a>
</li>
<li id="li_submenu_tutors-on-duty_2" >
<a class="li_submenu_tutors-on-duty_2_a" href="http://www.encs.concordia.ca/resources/tutors-on-duty/">
Tutors on duty </a>
</li>


<li id="li_submenu_help-desk_2" >
<a class="li_submenu_help-desk_2_a" href="http://www.encs.concordia.ca/resources/help-desk/">
Help desk </a>
</li>
<li id="li_submenu_room-bookings_2" >
<a class="li_submenu_room-bookings_2_a" href="http://www.encs.concordia.ca/resources/room-bookings/">
Room bookings </a>
</li></ul>
</div>
...
<!-- InstanceBeginEditable name="Sidebar" -->
  <div class="sidebar_box_1">
	<h2>Web calendar</h2>
	<p>The <a href="https://atlas.encs.concordia.ca/calendar/login.php">online Web calendar</a> can help you to keep your schedule straight and will also allow you to see schedules of room bookings, events, etc.</p>
	<p>View the <a href="https://atlas.encs.concordia.ca/calendar/month.php">public ENCS web calendar</a>. </p>
  </div>
  <div class="sidebar_box_1">
	<h2>Webmail</h2>
	<p>Keep up-to-date with your ENCS e-mail. <a href="https://mail.encs.concordia.ca/horde/imp/">Webmail</a> allows you to access your account from anywhere.</p>
</div>
  <div class="sidebar_box_1">
	<h2>Electronic Assignment Submission</h2>
	<p>In the EAS system students can submit their assignments online any time from anywhere using any Web browser. The online student submission is permitted only for courses registered for EAS. Find out more about <a href="https://fis.encs.concordia.ca/eas/servlet/description">electronic assignment submission</a>.</p>
	</div>	
  <div class="sidebar_box_1">
	<h2>Campus Resources </h2>
	<p>For more information about general resources available on the Concordia University campus, please consult the list of resources for:</p>
	<ul>
	  <li><a href="http://www.concordia.ca/info/students/">current students</a></li>
	  <li><a href="http://www.concordia.ca/info/facultystaff/">faculty and staff</a></li>
	</ul>
	</div>	
  <div class="sidebar_box_1">
	<h2>Iron Ring</h2>
	<p>Looking to participate in this right of passage for engineers? Take a look at this page about the <a href="http://ironring.encs.concordia.ca/">Iron Ring</a> in order to find out where and when the next ceremony will be held and how to apply.</p>
	</div>	
...
<!-- InstanceBeginEditable name="MainContent" -->
  <p>The Faculty of Engineering and Computer Science offers many resources to its faculty, staff, and students, including:</p>
  
	<h2>Schedules</h2>
	<p>See all <a href="http://www.encs.concordia.ca/resources/schedules/">schedules for the Fall, Summer, and Winter semesters</a>, plus you'll be able to search labs by department, load assignment, and also see the full lab listings for each term.</p>
	<h2>Faculty &amp; staff directory</h2>
	<p>If you're looking to contact someone in the Faculty but you're not quite sure who the right person would be, our online directory can help! Contact information for all faculty and staff members is listed here. Consult the <a href="http://www.encs.concordia.ca/resources/faculty-and-staff-directory/">faculty &amp; staff directory</a>.</p>
	
	<h2>Tutors on duty</h2>
	<p>For undergraduate students looking for some extra help on their class assignents, the <a href="http://www.encs.concordia.ca/resources/tutors-on-duty/">Tutors on duty</a> are the perfect resource. This prage provides an overview of the service plus a detailed schedule.</p>
	
	<h2>Help desk</h2>
	<p>Have some pressing IT questions? Get help from the <a href="http://www.encs.concordia.ca/resources/help-desk/">Help desk</a>, run by Academic Information Technology Services. They can help answer questions about:</p>
	<ul>
	  <li>printing,</li>
      <li>accounts and access,</li>
	  <li>email,</li>
	  <li>data storage and transfer,</li>
	  <li>plus videos, tutorials, and how-tos.</li>
	</ul>
	<h2>Room bookings</h2>
	<p>Want to book one of the rooms within the jurisdiction of the Faculty of Engineering and Computer Science? Use our online form. Find out more about <a href="http://www.encs.concordia.ca/resources/room-bookings/">ENCS room bookings</a>.</p>
<!-- InstanceEndEditable --><br class="hide" />
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/resources/index.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Resources - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/resources/index.php ...</p>
