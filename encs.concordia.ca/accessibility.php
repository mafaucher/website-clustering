...
//<![CDATA[
		...
		$(document).ready( function() {
			textsizeactive(); main_trigger();
						replace_localtools('www.encs.concordia.ca','%2Faccessibility.php','Accessibility', '/');
					});
	}
  ...
  <div id="globaltools_bg">
    <div class="globaltools_pagewidth">
      ...
      <ul class="accesstools">
        <li><a href="http://www.encs.concordia.ca/accessibility.php#maincontent" accesskey="s">Skip to Content</a></li>
...
News &amp; events </a>
		...
		<div class="insidecontent ">
			...
			<p class="breadcrumb"><a href="http://www.encs.concordia.ca/index.php">ENCS Home</a> &gt; </p>
...
<div id="footer">
 ...
 <div class="clear">&nbsp;</div>
  ...
  <div id="backtotop">
    <p style="margin-bottom: 0"><a href="http://www.encs.concordia.ca/accessibility.php#top">Back to Top</a></p>
  </div>
  <div class="url">
    <h2>Page Info</h2>
    <p><strong>Page Title</strong>: Accessibility - Concordia University - Montreal, Quebec, Canada</p>
    <p><strong>Page URL</strong>:http://www.encs.concordia.ca/accessibility.php ...</p>
